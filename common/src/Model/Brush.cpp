...
Brush::Brush(const Brush &other) :
    m_faces{other.m_faces}, m_geometry{other.m_geometry ? std::make_unique<BrushGeometry>(*other.m_geometry, CopyCallback()) : nullptr} {
  if (m_geometry) {
...
Result<Brush> Brush::createBrush(
    const MapFormat mapFormat, const vm::bbox3 &worldBounds, const std::string &defaultTextureName, const BrushGeometry &geometry,
