...
class Game : public IO::EntityDefinitionLoader, public IO::EntityModelLoader {
  ...
  private: // subclassing interface
    ...
    virtual Result<std::unique_ptr<WorldNode>> doLoadMap(MapFormat format, const vm::bbox3 &worldBounds, const std::filesystem::path &path, Logger &logger) const = 0;
    ...
    virtual std::filesystem::path doFindEntityDefinitionFile(const Assets::EntityDefinitionFileSpec &spec, const std::vector<std::filesystem::path> &searchPaths) const = 0;
