...
{
  kdl::struct_stream{str} << "TagAttribute" << "m_type" << attr.m_type << "m_name"
                          << attr.m_name;
  return str;
}
...
{
  kdl::struct_stream{str} << "Tag" << "m_index" << m_index << "m_name" << m_name
...
{
  kdl::struct_stream{str} << "SmartTag" << "m_index" << m_index << "m_name" << m_name
                          << "m_attributes" << m_attributes << "m_matcher" << *m_matcher;
}
} // namespace Model
} // namespace TrenchBroom
