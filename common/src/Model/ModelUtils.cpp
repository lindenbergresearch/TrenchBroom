...
LayerNode *findContainingLayer(Node *node) {
  return node->accept(
      kdl::overload(
          [](WorldNode *) -> LayerNode * { return nullptr; }, [](LayerNode *layer) -> LayerNode * { return layer; },
...
GroupNode *findContainingGroup(Node *node) {
  return node->visitParent(
      kdl::overload(
          [](WorldNode *) -> GroupNode * { return nullptr; }, [](LayerNode *) -> GroupNode * { return nullptr; },
 ...
 */
template<typename P> static std::vector<Node *> collectMatchingNodes(
...
std::vector<BrushFaceHandle> collectSelectedBrushFaces(const std::vector<Node *> &nodes) {
  return collectBrushFaces(
      nodes, [](const BrushNode &, const BrushFace &brushFace) {
...
vm::bbox3 computeLogicalBounds(const std::vector<Node *> &nodes, const vm::bbox3 &defaultBounds) {
  ...
  Node::visitAll(
      nodes, kdl::overload(
          [](const WorldNode *) {}, [](const LayerNode *) {}, [&](const GroupNode *group) { builder.add(group->logicalBounds()); },
...
vm::bbox3 computePhysicalBounds(const std::vector<Node *> &nodes, const vm::bbox3 &defaultBounds) {
  ...
  Node::visitAll(
      nodes, kdl::overload(
          [](const WorldNode *) {}, [](const LayerNode *) {}, [&](const GroupNode *group) { builder.add(group->physicalBounds()); },
...
std::vector<BrushNode *> filterBrushNodes(const std::vector<Node *> &nodes) {
  ...
  for (Node *node : nodes) {
    node->accept(
        kdl::overload(
            [](WorldNode *) {}, [](LayerNode *) {}, [](GroupNode *) {}, [](EntityNode *) {}, [&](BrushNode *brushNode) { result.push_back(brushNode); },
            [](PatchNode *) {}
        ));
  }
  return result;
...
std::vector<EntityNode *> filterEntityNodes(const std::vector<Node *> &nodes) {
  ...
  for (Node *node : nodes) {
    node->accept(
        kdl::overload(
            [](WorldNode *) {}, [](LayerNode *) {}, [](GroupNode *) {}, [&](EntityNode *entityNode) { result.push_back(entityNode); }, [](BrushNode *) {},
            [](PatchNode *) {}
        ));
  }
  return result;
