...
template<typename T, typename FP, typename VP> std::optional<typename Polyhedron<T, FP, VP>::ClipResult::FailureReason> Polyhedron<T, FP, VP>::checkIntersects(
...
template<typename T, typename FP, typename VP> typename Polyhedron<T, FP, VP>::HalfEdge *Polyhedron<T, FP, VP>::findInitialIntersectingEdge(
    const vm::plane<T, 3> &plane
) const {
...
template<typename T, typename FP, typename VP> std::tuple<typename Polyhedron<T, FP, VP>::HalfEdge *, bool> Polyhedron<T, FP, VP>::intersectWithPlane(
...
/*
 ...
 the given plane.
 */
template<typename T, typename FP, typename VP> typename Polyhedron<T, FP, VP>::HalfEdge *Polyhedron<T, FP, VP>::findNextIntersectingEdge(
