...
BrushFace::BrushFace(const BrushFace &other)
    : Taggable(other), m_points(other.m_points), m_boundary(other.m_boundary), m_attributes(other.m_attributes), m_textureReference(other.m_textureReference), m_texCoordSystem(other.m_texCoordSystem ? other.m_texCoordSystem->clone() : nullptr), m_geometry(nullptr), m_lineNumber(other.m_lineNumber), m_lineCount(other.m_lineCount), m_selected(other.m_selected), m_markedToRenderFace(false) {
}

BrushFace::BrushFace(BrushFace &&other) noexcept
    : Taggable(other), m_points(std::move(other.m_points)), m_boundary(std::move(other.m_boundary)), m_attributes(std::move(other.m_attributes)), m_textureReference(std::move(other.m_textureReference)), m_texCoordSystem(std::move(other.m_texCoordSystem)), m_geometry(other.m_geometry), m_lineNumber(other.m_lineNumber), m_lineCount(other.m_lineCount), m_selected(other.m_selected), m_markedToRenderFace(false) {
}
...
Result<BrushFace> BrushFace::create(const vm::vec3 &point0, const vm::vec3 &point1, const vm::vec3 &point2, const BrushFaceAttributes &attributes, const MapFormat mapFormat) {
    return Model::isParallelTexCoordSystem(mapFormat) ? BrushFace::create(point0, point1, point2, attributes, std::make_unique<ParallelTexCoordSystem>(point0, point1, point2, attributes)) : BrushFace::create(point0, point1, point2, attributes, std::make_unique<ParaxialTexCoordSystem>(point0, point1, point2, attributes));
}

Result<BrushFace> BrushFace::createFromStandard(const vm::vec3 &point0, const vm::vec3 &point1, const vm::vec3 &point2, const BrushFaceAttributes &inputAttribs, const MapFormat mapFormat) {
...
Result<BrushFace> BrushFace::createFromValve(const vm::vec3 &point1, const vm::vec3 &point2, const vm::vec3 &point3, const BrushFaceAttributes &inputAttribs, const vm::vec3 &texAxisX, const vm::vec3 &texAxisY, MapFormat mapFormat) {
    assert(mapFormat != MapFormat::Unknown);
...
Result<BrushFace> BrushFace::create(const vm::vec3 &point0, const vm::vec3 &point1, const vm::vec3 &point2, const BrushFaceAttributes &attributes, std::unique_ptr<TexCoordSystem> texCoordSystem) {
...
void BrushFace::flipTexture(const vm::vec3 & /* cameraUp */, const vm::vec3 &cameraRight, const vm::direction cameraRelativeFlipDirection) {
    ...
    bool flipTextureX = (cameraRelativeFlipDirection == vm::direction::left || cameraRelativeFlipDirection == vm::direction::right);
