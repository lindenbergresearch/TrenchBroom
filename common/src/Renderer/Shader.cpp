...
Shader::Shader(std::string name, const GLenum type, const GLuint shaderId) : m_name{std::move(name)}, m_type{
    type
}, m_shaderId{shaderId} {
...
Shader::Shader(Shader &&other) noexcept: m_name{std::move(other.m_name)}, m_type{other.m_type}, m_shaderId{
    std::exchange(other.m_shaderId, 0)
} {
}
