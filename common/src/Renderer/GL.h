...
template<GLenum T> struct GLType {
  using Type = GLvoid;
};
template<> struct GLType<GL_BYTE> {
  using Type = GLbyte;
};
template<> struct GLType<GL_UNSIGNED_BYTE> {
  using Type = GLubyte;
};
template<> struct GLType<GL_SHORT> {
  using Type = GLshort;
};
template<> struct GLType<GL_UNSIGNED_SHORT> {
  using Type = GLushort;
};
template<> struct GLType<GL_INT> {
  using Type = GLint;
};
template<> struct GLType<GL_UNSIGNED_INT> {
  using Type = GLuint;
};
template<> struct GLType<GL_FLOAT> {
  using Type = GLfloat;
};
template<> struct GLType<GL_DOUBLE> {
  using Type = GLdouble;
};
