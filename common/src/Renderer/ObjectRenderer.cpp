...
void ObjectRenderer::addNode(Model::Node *node) {
  node->accept(
      kdl::overload(
          [](Model::WorldNode *) {}, [](Model::LayerNode *) {}, [&](Model::GroupNode *group) { m_groupRenderer.addGroup(group); },
...
void ObjectRenderer::removeNode(Model::Node *node) {
  node->accept(
      kdl::overload(
          [](Model::WorldNode *) {}, [](Model::LayerNode *) {}, [&](Model::GroupNode *group) { m_groupRenderer.removeGroup(group); },
...
void ObjectRenderer::invalidateNode(Model::Node *node) {
  node->accept(
      kdl::overload(
          [](Model::WorldNode *) {}, [](Model::LayerNode *) {}, [&](Model::GroupNode *group) { m_groupRenderer.invalidateGroup(group); },
