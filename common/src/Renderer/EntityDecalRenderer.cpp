...
std::vector<Vertex> createDecalBrushFace(const Model::EntityNode *entityNode, const Model::BrushNode *brush, const Model::BrushFace &face, const Assets::Texture *texture) {
...
void EntityDecalRenderer::updateNode(Model::Node *node) {
    node->accept(kdl::overload([](Model::WorldNode *) {}, [](Model::LayerNode *) {}, [](Model::GroupNode *) {}, [&](const Model::EntityNode *entity) { updateEntity(entity); }, [&](const Model::BrushNode *brush) { updateBrush(brush); }, [](Model::PatchNode *) {}));
}

void EntityDecalRenderer::removeNode(Model::Node *node) {
    node->accept(kdl::overload([](Model::WorldNode *) {}, [](Model::LayerNode *) {}, [](Model::GroupNode *) {}, [&](const Model::EntityNode *entity) { removeEntity(entity); }, [&](const Model::BrushNode *brush) { removeBrush(brush); }, [](Model::PatchNode *) {}));
}
...
void EntityDecalRenderer::validateDecalData(const Model::EntityNode *entityNode, EntityDecalData &data) const {
    ...
    for (const auto &brush : data.brushes) {
        for (const auto &face : brush->brush().faces()) {
            ...
            if (vm::intersect_bbox_polygon(shrunkBounds, facePolygon.begin(), facePolygon.end())) {
