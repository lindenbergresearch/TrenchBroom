...
DirectEdgeRenderer::DirectEdgeRenderer(VertexArray vertexArray, IndexRangeMap indexRanges) : m_vertexArray{
    std::move(vertexArray)
}, m_indexRanges{std::move(indexRanges)} {
}

DirectEdgeRenderer::DirectEdgeRenderer(VertexArray vertexArray, const PrimType primType) : m_vertexArray{
    std::move(vertexArray)
...
IndexedEdgeRenderer::Render::Render(const EdgeRenderer::Params &params, std::shared_ptr<BrushVertexArray> vertexArray,
...
IndexedEdgeRenderer::IndexedEdgeRenderer(std::shared_ptr<BrushVertexArray> vertexArray, std::shared_ptr<BrushIndexArray> indexArray) : m_vertexArray{
    std::move(vertexArray)
