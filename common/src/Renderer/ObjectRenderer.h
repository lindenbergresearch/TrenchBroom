...
class ObjectRenderer {
  ...
  public:
    template<typename BrushFilterT> ObjectRenderer(Logger &logger, Assets::EntityModelManager &entityModelManager, const Model::EditorContext &editorContext, const BrushFilterT &brushFilter)
