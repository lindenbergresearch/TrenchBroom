...
public:
  template<typename BrushFilterT> ObjectRenderer(
      ...
      :
      m_groupRenderer{editorContext}, m_entityRenderer{logger, entityModelManager, editorContext}, m_brushRenderer{brushFilter},
