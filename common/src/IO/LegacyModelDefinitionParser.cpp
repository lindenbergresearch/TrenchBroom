...
namespace IO {
LegacyModelDefinitionTokenizer::LegacyModelDefinitionTokenizer(std::string_view str, const size_t line, const size_t column) : Tokenizer{std::move(str), "", 0, line, column} {
}
...
LegacyModelDefinitionParser::LegacyModelDefinitionParser(std::string_view str, const size_t line, const size_t column) : m_tokenizer{std::move(str), line, column} {
}
