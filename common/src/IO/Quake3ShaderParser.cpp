...
Quake3ShaderParser::TokenNameMap Quake3ShaderParser::tokenNames() const {
    return {{Quake3ShaderToken::Number, "number"}, {Quake3ShaderToken::String, "string"}, {Quake3ShaderToken::Variable, "variable"}, {Quake3ShaderToken::OBrace, "'{'"}, {Quake3ShaderToken::CBrace, "'}'"}, {Quake3ShaderToken::Comment, "comment"}, {Quake3ShaderToken::Eol, "end of line"}, {Quake3ShaderToken::Eof, "end of file"},
    };
}
