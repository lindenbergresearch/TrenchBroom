...
StandardMapParser::StandardMapParser(std::string_view str, const Model::MapFormat sourceMapFormat, const Model::MapFormat targetMapFormat) : m_tokenizer(QuakeMapTokenizer(std::move(str))), m_sourceMapFormat(sourceMapFormat), m_targetMapFormat(targetMapFormat) {
