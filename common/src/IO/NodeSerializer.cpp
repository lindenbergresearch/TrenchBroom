...
namespace IO {
NodeSerializer::NodeSerializer() : m_entityNo(0), m_brushNo(0), m_exporting(false) {
}
...
void NodeSerializer::defaultLayer(const Model::WorldNode &world) {
    ...
    if (defaultLayer.color()) {
        worldEntity.addOrUpdateProperty(entityPropertyConfig, Model::EntityPropertyKeys::LayerColor, kdl::str_to_string(*defaultLayer.color()));
    } else {
    ...
    if (defaultLayerNode->lockState() == Model::LockState::Locked) {
        worldEntity.addOrUpdateProperty(entityPropertyConfig, Model::EntityPropertyKeys::LayerLocked, Model::EntityPropertyValues::LayerLockedValue);
    } else {
        worldEntity.removeProperty(entityPropertyConfig, Model::EntityPropertyKeys::LayerLocked);
    }

    if (defaultLayerNode->hidden()) {
        worldEntity.addOrUpdateProperty(entityPropertyConfig, Model::EntityPropertyKeys::LayerHidden, Model::EntityPropertyValues::LayerHiddenValue);
    } else {
        worldEntity.removeProperty(entityPropertyConfig, Model::EntityPropertyKeys::LayerHidden);
    }

    if (defaultLayer.omitFromExport()) {
        worldEntity.addOrUpdateProperty(entityPropertyConfig, Model::EntityPropertyKeys::LayerOmitFromExport, Model::EntityPropertyValues::LayerOmitFromExportValue);
    } else {
...
void NodeSerializer::entity(const Model::Node *node, const std::vector<Model::EntityProperty> &properties, const std::vector<Model::EntityProperty> &extraProperties, const Model::Node *brushParent) {
    ...
    brushParent->visitChildren(kdl::overload([](const Model::WorldNode *) {}, [](const Model::LayerNode *) {}, [](const Model::GroupNode *) {}, [](const Model::EntityNode *) {}, [&](const Model::BrushNode *b) { brush(b); }, [&](const Model::PatchNode *p) { patch(p); }));
...
std::vector<Model::EntityProperty> NodeSerializer::parentProperties(const Model::Node *node) {
    ...
    node->accept(kdl::overload([](const Model::WorldNode *) {}, [&](const Model::LayerNode *layerNode) {
        properties.push_back(Model::EntityProperty(Model::EntityPropertyKeys::Layer, kdl::str_to_string(*layerNode->persistentId())));
    }, [&](const Model::GroupNode *groupNode) {
        properties.push_back(Model::EntityProperty(Model::EntityPropertyKeys::Group, kdl::str_to_string(*groupNode->persistentId())));
...
std::vector<Model::EntityProperty> NodeSerializer::layerProperties(const Model::LayerNode *layerNode) {
    std::vector<Model::EntityProperty> result = {
        Model::EntityProperty(Model::EntityPropertyKeys::Classname, Model::EntityPropertyValues::LayerClassname), Model::EntityProperty(Model::EntityPropertyKeys::GroupType, Model::EntityPropertyValues::GroupTypeLayer), Model::EntityProperty(Model::EntityPropertyKeys::LayerName, layerNode->name()), Model::EntityProperty(Model::EntityPropertyKeys::LayerId, kdl::str_to_string(*layerNode->persistentId())),
    };
...
std::vector<Model::EntityProperty> NodeSerializer::groupProperties(const Model::GroupNode *groupNode) {
    auto result = std::vector<Model::EntityProperty>{
        Model::EntityProperty(Model::EntityPropertyKeys::Classname, Model::EntityPropertyValues::GroupClassname), Model::EntityProperty(Model::EntityPropertyKeys::GroupType, Model::EntityPropertyValues::GroupTypeGroup), Model::EntityProperty(Model::EntityPropertyKeys::GroupName, groupNode->name()), Model::EntityProperty(Model::EntityPropertyKeys::GroupId, kdl::str_to_string(*groupNode->persistentId())),
    };
    ...
    if (transformation != vm::mat4x4d::identity()) {
        const auto transformationStr = fmt::format("{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}", transformation[0][0], transformation[1][0], transformation[2][0], transformation[3][0], // row 0
