...
void NodeSerializer::entity(
    const Model::Node *node, const std::vector<Model::EntityProperty> &properties, const std::vector<Model::EntityProperty> &extraProperties,
...
std::vector<Model::EntityProperty> NodeSerializer::parentProperties(const Model::Node *node) {
    ...
    node->accept(
        kdl::overload(
            [](const Model::WorldNode *) {}, [&](const Model::LayerNode *layerNode) { properties.push_back(
                                                                                          Model::EntityProperty(
                                                                                              Model::EntityPropertyKeys::Layer, kdl::str_to_string(*layerNode->persistentId()))); }, [&](const Model::GroupNode *groupNode) { properties.push_back(
                                                                                                                                                                                                                                                                     Model::EntityProperty(
                                                                                                                                                                                                                                                                         Model::EntityPropertyKeys::Group, kdl::str_to_string(*groupNode->persistentId()))); }, [](const Model::EntityNode *) {}, [](const Model::BrushNode *) {}, [](const Model::PatchNode *) {}));
