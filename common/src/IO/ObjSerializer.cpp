...
ObjSerializer::ObjSerializer(std::ostream &objStream, std::ostream &mtlStream, std::string mtlFilename, IO::ObjExportOptions options) : m_objStream{objStream}, m_mtlStream{mtlStream}, m_mtlFilename{std::move(mtlFilename)}, m_options{
                                                                                                                                                                                                                                   std::move(options)} {
...
static void writeObjFile(
    std::ostream &str, const std::string mtlFilename, const std::vector<vm::vec3> &vertices, const std::vector<vm::vec2f> &texCoords,
