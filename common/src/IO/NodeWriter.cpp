...
static void doWriteNodes(NodeSerializer &serializer, const std::vector<Model::Node *> &nodes, const Model::Node *parent = nullptr) {
    ...
    for (const auto *node : nodes) {
        node->accept(kdl::overload([](const Model::WorldNode *) {}, [](const Model::LayerNode *) {}, [&](auto &&thisLambda, const Model::GroupNode *group) {
...
void NodeWriter::writeNodes(const std::vector<Model::Node *> &nodes) {
    ...
    for (auto *node : nodes) {
        node->accept(kdl::overload([](Model::WorldNode *) {}, [](Model::LayerNode *) {}, [&](Model::GroupNode *group) { groups.push_back(group); }, [&](Model::EntityNode *entity) { entities.push_back(entity); }, [&](Model::BrushNode *brush) {
