...
PropertyDefinition::PropertyDefinition(
    std::string key, const PropertyDefinitionType type, std::string shortDescription, std::string longDescription, const bool readOnly
) : m_key{std::move(key)}, m_type{type}, m_shortDescription{
    std::move(shortDescription)
}, m_longDescription{std::move(longDescription)}, m_readOnly{readOnly} {
}
...
std::unique_ptr<PropertyDefinition> PropertyDefinition::doClone(
    std::string key, std::string shortDescription, std::string longDescription, bool readOnly
) const {
  return std::make_unique<PropertyDefinition>(
      std::move(key), type(), std::move(shortDescription), std::move(longDescription), readOnly
  );
}

StringPropertyDefinition::StringPropertyDefinition(
    std::string key, std::string shortDescription, std::string longDescription, const bool readOnly, std::optional<std::string> defaultValue
...
std::unique_ptr<PropertyDefinition> StringPropertyDefinition::doClone(
  ...
  return std::make_unique<StringPropertyDefinition>(
      std::move(key), std::move(shortDescription), std::move(longDescription), readOnly, m_defaultValue
  );
}

BooleanPropertyDefinition::BooleanPropertyDefinition(
    std::string key, std::string shortDescription, std::string longDescription, const bool readOnly, std::optional<bool> defaultValue
) : PropertyDefinitionWithDefaultValue{
...
IntegerPropertyDefinition::IntegerPropertyDefinition(
    std::string key, std::string shortDescription, std::string longDescription, const bool readOnly, std::optional<int> defaultValue
) : PropertyDefinitionWithDefaultValue{
...
FloatPropertyDefinition::FloatPropertyDefinition(
    std::string key, std::string shortDescription, std::string longDescription, const bool readOnly, std::optional<float> defaultValue
) : PropertyDefinitionWithDefaultValue{
...
ChoicePropertyDefinition::ChoicePropertyDefinition(
    std::string key, std::string shortDescription, std::string longDescription, ChoicePropertyOption::List options, const bool readOnly,
    std::optional<std::string> defaultValue
) : PropertyDefinitionWithDefaultValue{
    std::move(key), PropertyDefinitionType::ChoiceProperty, std::move(shortDescription), std::move(longDescription), readOnly, std::move(defaultValue)
...
std::unique_ptr<PropertyDefinition> ChoicePropertyDefinition::doClone(
  ...
  return std::make_unique<ChoicePropertyDefinition>(
      std::move(key), std::move(shortDescription), std::move(longDescription), options(), readOnly, m_defaultValue
  );
}
...
FlagsPropertyOption::FlagsPropertyOption(const int value, std::string shortDescription, std::string longDescription, const bool isDefault) :
    m_value{value}, m_shortDescription{std::move(shortDescription)}, m_longDescription{
...
FlagsPropertyDefinition::FlagsPropertyDefinition(std::string key) : PropertyDefinition{std::move(key), PropertyDefinitionType::FlagsProperty, "", "", false} {
}
...
std::unique_ptr<PropertyDefinition> FlagsPropertyDefinition::doClone(
  ...
  for (const auto &option : options()) {
    result->addOption(
        option.value(), option.shortDescription(), option.longDescription(), option.isDefault());
  }
  return result;
}
