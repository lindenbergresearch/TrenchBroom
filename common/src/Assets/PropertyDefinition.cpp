...
PropertyDefinition::PropertyDefinition(
    const std::string &key, const PropertyDefinitionType type, const std::string &shortDescription, const std::string &longDescription, const bool readOnly
...
PropertyDefinition *PropertyDefinition::clone(
    const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly
) const {
...
StringPropertyDefinition::StringPropertyDefinition(
    const std::string &key, const std::string &shortDescription, const std::string &longDescription, const bool readOnly, std::optional<std::string> defaultValue
) : PropertyDefinitionWithDefaultValue(
    key, PropertyDefinitionType::StringProperty, shortDescription, longDescription, readOnly, std::move(defaultValue)) {
}
...
BooleanPropertyDefinition::BooleanPropertyDefinition(
    const std::string &key, const std::string &shortDescription, const std::string &longDescription, const bool readOnly, std::optional<bool> defaultValue
) : PropertyDefinitionWithDefaultValue(
    key, PropertyDefinitionType::BooleanProperty, shortDescription, longDescription, readOnly, std::move(defaultValue)) {
}
...
IntegerPropertyDefinition::IntegerPropertyDefinition(
    const std::string &key, const std::string &shortDescription, const std::string &longDescription, const bool readOnly, std::optional<int> defaultValue
) : PropertyDefinitionWithDefaultValue(
    key, PropertyDefinitionType::IntegerProperty, shortDescription, longDescription, readOnly, std::move(defaultValue)) {
}
...
FloatPropertyDefinition::FloatPropertyDefinition(
    const std::string &key, const std::string &shortDescription, const std::string &longDescription, const bool readOnly, std::optional<float> defaultValue
) : PropertyDefinitionWithDefaultValue(
    key, PropertyDefinitionType::FloatProperty, shortDescription, longDescription, readOnly, std::move(defaultValue)) {
}
...
ChoicePropertyDefinition::ChoicePropertyDefinition(
    const std::string &key, const std::string &shortDescription, const std::string &longDescription, const ChoicePropertyOption::List &options, const bool readOnly, std::optional<std::string> defaultValue
) : PropertyDefinitionWithDefaultValue(
    key, PropertyDefinitionType::ChoiceProperty, shortDescription, longDescription, readOnly, std::move(defaultValue)), m_options(options) {
}
...
FlagsPropertyOption::FlagsPropertyOption(
    const int value, const std::string &shortDescription, const std::string &longDescription, const bool isDefault
