...
PropertyDefinition::PropertyDefinition(
    ...
    const bool readOnly)
    : m_key{std::move(key)}, m_type{type}, m_shortDescription{std::move(shortDescription)},
...
ChoicePropertyOption::ChoicePropertyOption(std::string value, std::string description)
    : m_value{std::move(value)}, m_description{std::move(description)} {
}
...
ChoicePropertyDefinition::ChoicePropertyDefinition(
    ...
    const bool readOnly,
    std::optional<std::string> defaultValue)
    : PropertyDefinitionWithDefaultValue{std::move(key), PropertyDefinitionType::ChoiceProperty,
                                         std::move(shortDescription), std::move(longDescription), readOnly,
                                         std::move(defaultValue)}, m_options{std::move(options)} {
}
...
FlagsPropertyOption::FlagsPropertyOption(
    ...
    : m_value{value}, m_shortDescription{std::move(shortDescription)}, m_longDescription{std::move(longDescription)},
