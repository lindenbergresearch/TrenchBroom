...
namespace Assets {
PropertyDefinition::PropertyDefinition(const std::string &key, const PropertyDefinitionType type, const std::string &shortDescription,
    const std::string &longDescription, const bool readOnly
) : m_key(key), m_type(type), m_shortDescription(shortDescription), m_longDescription(longDescription), m_readOnly(readOnly) {
}
...
PropertyDefinition *
PropertyDefinition::clone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
    return doClone(key, shortDescription, longDescription, readOnly);
}

PropertyDefinition *
PropertyDefinition::doClone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
    return new PropertyDefinition(key, type(), shortDescription, longDescription, readOnly);
}

StringPropertyDefinition::StringPropertyDefinition(const std::string &key, const std::string &shortDescription, const std::string &longDescription,
    const bool readOnly, std::optional<std::string> defaultValue
...
PropertyDefinition *
StringPropertyDefinition::doClone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
    return new StringPropertyDefinition(key, shortDescription, longDescription, readOnly, m_defaultValue);
}

BooleanPropertyDefinition::BooleanPropertyDefinition(const std::string &key, const std::string &shortDescription, const std::string &longDescription,
    const bool readOnly, std::optional<bool> defaultValue
...
PropertyDefinition *
BooleanPropertyDefinition::doClone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
    return new BooleanPropertyDefinition(key, shortDescription, longDescription, readOnly, m_defaultValue);
}

IntegerPropertyDefinition::IntegerPropertyDefinition(const std::string &key, const std::string &shortDescription, const std::string &longDescription,
    const bool readOnly, std::optional<int> defaultValue
...
PropertyDefinition *
IntegerPropertyDefinition::doClone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
    return new IntegerPropertyDefinition(key, shortDescription, longDescription, readOnly, m_defaultValue);
}

FloatPropertyDefinition::FloatPropertyDefinition(const std::string &key, const std::string &shortDescription, const std::string &longDescription,
    const bool readOnly, std::optional<float> defaultValue
...
PropertyDefinition *
FloatPropertyDefinition::doClone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
    return new FloatPropertyDefinition(key, shortDescription, longDescription, readOnly, m_defaultValue);
}

ChoicePropertyOption::ChoicePropertyOption(const std::string &value, const std::string &description) : m_value(value), m_description(description) {
}
...
ChoicePropertyDefinition::ChoicePropertyDefinition(const std::string &key, const std::string &shortDescription, const std::string &longDescription,
    const ChoicePropertyOption::List &options, const bool readOnly, std::optional<std::string> defaultValue
...
PropertyDefinition *
ChoicePropertyDefinition::doClone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
...
FlagsPropertyOption::FlagsPropertyOption(const int value, const std::string &shortDescription, const std::string &longDescription, const bool isDefault)
    : m_value(value), m_shortDescription(shortDescription), m_longDescription(longDescription), m_isDefault(isDefault) {
}
...
FlagsPropertyDefinition::FlagsPropertyDefinition(const std::string &key) : PropertyDefinition(key, PropertyDefinitionType::FlagsProperty, "", "", false) {
}
...
PropertyDefinition *
FlagsPropertyDefinition::doClone(const std::string &key, const std::string & /* shortDescription */, const std::string & /* longDescription */,
    bool /* readOnly */
) const {
...
UnknownPropertyDefinition::UnknownPropertyDefinition(const std::string &key, const std::string &shortDescription, const std::string &longDescription,
    const bool readOnly, std::optional<std::string> defaultValue
) : StringPropertyDefinition(key, shortDescription, longDescription, readOnly, std::move(defaultValue)) {
}

PropertyDefinition *
UnknownPropertyDefinition::doClone(const std::string &key, const std::string &shortDescription, const std::string &longDescription, bool readOnly) const {
