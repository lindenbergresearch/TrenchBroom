...
class MapView2D : public MapViewBase {
  ...
  public:
    typedef enum {
      ViewPlane_XY, ViewPlane_XZ, ViewPlane_YZ
    } ViewPlane;
  ...
  public:
    MapView2D(std::weak_ptr<MapDocument> document, MapViewToolBox &toolBox, Renderer::MapRenderer &renderer, GLContextManager &contextManager, ViewPlane viewPlane, Logger *logger);
  ...
  private: // implement MapView interface
    ...
    void animateCamera(const vm::vec3f &position, const vm::vec3f &direction, const vm::vec3f &up, float zoom, const int duration = DefaultCameraAnimationDuration);
