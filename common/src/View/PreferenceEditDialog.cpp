...
#define IS_TYPE(TNAME, TVAR, TBASE) Preference<TNAME> *TVAR = dynamic_cast<Preference<TNAME> *>(TBASE)
        ...
        connect(browseButton, &QPushButton::clicked, this, [=]() {
              const QString pathStr =
                  QFileDialog::getOpenFileName(
                      this,
                      tr("%1 Path").arg(QString::fromStdString(preference->defaultValue().string().c_str())),
