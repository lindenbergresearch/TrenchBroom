...
CameraAnimation::CameraAnimation(
    ...
    : Animation{AnimationType, Curve::EaseInEaseOut, duration}, m_camera{camera}, m_startPosition{m_camera.position()},
      m_startDirection{m_camera.direction()}, m_startUp{m_camera.up()}, m_startZoom{m_camera.zoom()},
      m_targetPosition{targetPosition}, m_targetDirection{targetDirection}, m_targetUp{targetUp},
