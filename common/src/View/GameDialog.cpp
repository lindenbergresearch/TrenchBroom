...
bool GameDialog::showNewDocumentDialog(QWidget *parent, std::string &gameName, Model::MapFormat &mapFormat) {
    GameDialog dialog(
        ...
        GameDialog::DialogType::New, parent);
...
GameDialog::GameDialog(const QString &title, const QString &infoText, const DialogType type, QWidget *parent) : QDialog(parent), m_dialogType(type), m_gameListBox(nullptr), m_mapFormatComboBox(nullptr), m_openPreferencesButton(nullptr), m_okButton(nullptr) {
