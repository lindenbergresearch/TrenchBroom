...
SliderWithLabel::SliderWithLabel(
    const int minimum, const int maximum, const float factor, const QString &format, const int maxSliderWidth, const int minLabelWidth, QWidget *parent) : QWidget(parent), m_slider(createSlider(minimum, maximum)), m_label(new QLabel()), m_factor(factor), m_format(format) {
