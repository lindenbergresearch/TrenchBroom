...
FlashSelectionAnimation::FlashSelectionAnimation(Renderer::MapRenderer &renderer, QWidget *view, const double duration) : Animation(AnimationType, Curve::EaseInEaseOut, duration), m_renderer(renderer), m_view(view) {
}
