...
SetVisibilityCommand::SetVisibilityCommand(std::vector<Model::Node *> nodes, const Action action) : UndoableCommand(makeName(action), false), m_nodes{std::move(nodes)}, m_action{action} {
}
