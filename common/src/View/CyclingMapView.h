...
class CyclingMapView : public MapViewContainer, public CameraLinkableView {
  ...
  public:
    CyclingMapView(std::weak_ptr<MapDocument> document, MapViewToolBox &toolBox, Renderer::MapRenderer &mapRenderer, GLContextManager &contextManager, int views, Logger *logger, QWidget *parent = nullptr);
