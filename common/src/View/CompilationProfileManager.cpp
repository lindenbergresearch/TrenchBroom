...
CompilationProfileManager::CompilationProfileManager(std::weak_ptr<MapDocument> document, Model::CompilationConfig config, QWidget *parent)
    ...
    outerLayout->setContentsMargins(LayoutConstants::NarrowHMargin, LayoutConstants::NarrowVMargin, LayoutConstants::NarrowHMargin, LayoutConstants::NarrowVMargin);
...
void CompilationProfileManager::addProfile() {
    m_config.profiles.push_back(Model::CompilationProfile{"unnamed", "${MAP_DIR_PATH}", {}});
