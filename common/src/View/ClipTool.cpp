...
private:
    struct ClipPoint {
      ...
      ClipPoint(const vm::vec3 &i_point, const std::vector<vm::vec3> &i_helpVectors) : point(i_point), helpVectors(i_helpVectors) {
      }
    };
...
public:
    PointClipStrategy() : m_numPoints(0), m_dragIndex(4) {
    }
