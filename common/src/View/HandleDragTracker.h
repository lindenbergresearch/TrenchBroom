...
template<typename Delegate> class HandleDragTracker : public DragTracker {
  ...
  public:
     ...
     */
    HandleDragTracker(Delegate delegate, const InputState &inputState, const vm::vec3 &initialHandlePosition, const vm::vec3 &initialHitPoint)
        : m_delegate{std::move(delegate)}, m_dragState{initialHandlePosition, initialHandlePosition, initialHandlePosition - initialHitPoint}, m_proposeHandlePosition{
 ...
 */
template<typename Delegate> std::unique_ptr<HandleDragTracker<Delegate>> createHandleDragTracker(Delegate delegate, const InputState &inputState, const vm::vec3 &initialHandlePosition, const vm::vec3 &initialHitPoint) {
