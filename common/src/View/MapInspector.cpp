...
MapInspector::MapInspector(std::weak_ptr<MapDocument> document, MapView *mapView, Inspector *inspector, QWidget *parent) : TabBookPage(parent), m_mapPropertiesEditorPanel(nullptr), m_modEditorPanel(nullptr), m_mapView(mapView), m_inspector(inspector) {
    createGui(document);
...
MapPropertiesEditor::MapPropertiesEditor(std::weak_ptr<MapDocument> document, QWidget *parent) : QWidget(parent), m_document(document), m_updatingGui(false), m_softBoundsDisabled(nullptr), m_softBoundsFromGame(nullptr),
                                                                                                 m_softBoundsFromGameMinLabel(nullptr), m_softBoundsFromGameMaxLabel(nullptr), m_softBoundsFromMap(nullptr), m_softBoundsFromMapMinEdit(nullptr),
