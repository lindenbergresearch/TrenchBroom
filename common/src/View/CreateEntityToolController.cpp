...
public:
    explicit CreateEntityDropTracker(
        const InputState &inputState, CreateEntityTool &tool, std::function<void(const InputState &, CreateEntityTool &tool)> updateEntityPosition) : m_tool{tool}, m_updateEntityPosition{
