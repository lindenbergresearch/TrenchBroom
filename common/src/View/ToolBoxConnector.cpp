...
void ToolBoxConnector::processEvent(const MouseEvent &event) {
    switch (event.type) {
    case MouseEvent::Type::Down:processMouseButtonDown(event);
        break;
    case MouseEvent::Type::Up:processMouseButtonUp(event);
        break;
    case MouseEvent::Type::Click:processMouseClick(event);
        break;
    case MouseEvent::Type::DoubleClick:processMouseDoubleClick(event);
        break;
    case MouseEvent::Type::Motion:processMouseMotion(event);
        break;
    case MouseEvent::Type::Scroll:processScroll(event);
        break;
    case MouseEvent::Type::DragStart:processDragStart(event);
        break;
    case MouseEvent::Type::Drag:processDrag(event);
        break;
    case MouseEvent::Type::DragEnd:processDragEnd(event);
        break;
        switchDefault();
    }
    m_inputState.setAnyToolDragging(m_toolBox->dragging());
...
MouseButtonState ToolBoxConnector::mouseButton(const MouseEvent &event) {
    switch (event.button) {
    case MouseEvent::Button::Left:return MouseButtons::MBLeft;
    case MouseEvent::Button::Middle:return MouseButtons::MBMiddle;
    case MouseEvent::Button::Right:return MouseButtons::MBRight;
    case MouseEvent::Button::Aux1:
    case MouseEvent::Button::Aux2:
    case MouseEvent::Button::None:return MouseButtons::MBNone;
        switchDefault();
    }
}
