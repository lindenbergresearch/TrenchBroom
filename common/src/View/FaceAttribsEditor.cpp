...
void FaceAttribsEditor::createGui(GLContextManager &contextManager) {
    ...
    faceAttribsLayout->setContentsMargins(LayoutConstants::NarrowHMargin, LayoutConstants::MediumVMargin, LayoutConstants::NarrowHMargin, LayoutConstants::MediumVMargin);
