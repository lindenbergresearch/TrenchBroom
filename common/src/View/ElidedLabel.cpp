...
namespace View {
ElidedLabel::ElidedLabel(const QString &text, const Qt::TextElideMode elideMode, QWidget *parent) : QWidget(parent), m_label(new QLabel(this)), m_elideMode(elideMode) {
