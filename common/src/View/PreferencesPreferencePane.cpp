...
PreferencesPreferencePane::PreferencesPreferencePane(QWidget *parent) : PreferencePane(parent), m_table(nullptr),
    m_model(nullptr), m_proxy(nullptr) {
    ...
    m_table->horizontalHeader()->setSectionResizeMode(PreferenceModel::Columns::Index,
        QHeaderView::ResizeMode::ResizeToContents
    );
    m_table->horizontalHeader()->setSectionResizeMode(PreferenceModel::Columns::Context,
        QHeaderView::ResizeMode::ResizeToContents
    );
    m_table->horizontalHeader()->setSectionResizeMode(PreferenceModel::Columns::Path,
        QHeaderView::ResizeMode::ResizeToContents
    );
    m_table->horizontalHeader()->setSectionResizeMode(PreferenceModel::Columns::Type, QHeaderView::ResizeMode::Stretch);
    m_table->horizontalHeader()->setSectionResizeMode(PreferenceModel::Columns::Default,
    ...
    layout->setContentsMargins(LayoutConstants::WideHMargin, LayoutConstants::WideHMargin, LayoutConstants::WideHMargin,
    ...
    connect(restoreDefaultButton, &QPushButton::clicked, this, [&]() {
          ...
          if (selectionModel->hasSelection()) {
              ...
              reply = QMessageBox::question(this,
                  "Advanced Preferences", "Reset selected preference to default value?",
