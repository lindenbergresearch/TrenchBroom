...
public:
    BrushVertexCommand(const std::string &name, std::vector<std::pair<Model::Node *, Model::NodeContents>> nodes, std::vector<vm::vec3> oldVertexPositions,
...
public:
    BrushEdgeCommand(const std::string &name, std::vector<std::pair<Model::Node *, Model::NodeContents>> nodes, std::vector<vm::segment3> oldEdgePositions,
...
public:
    BrushFaceCommand(const std::string &name, std::vector<std::pair<Model::Node *, Model::NodeContents>> nodes, std::vector<vm::polygon3> oldFacePositions,
