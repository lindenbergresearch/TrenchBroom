...
class PropertyRow {
  ...
  public:
    ...
    static std::map<std::string, PropertyRow> rowsForEntityNodes(const std::vector<Model::EntityNodeBase *> &nodes, bool showDefaultRows, bool showPreservedProperties);
