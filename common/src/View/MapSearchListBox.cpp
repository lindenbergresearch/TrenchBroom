...
SearchListBoxItemRenderer::SearchListBoxItemRenderer(
    std::weak_ptr<MapDocument> document, MapView *mapView, Model::EntityNodeBase *node, QWidget *parent) : ControlListBoxItemRenderer(parent), m_document(std::move(document)), m_node(node), m_mapView(mapView) {
...
MapSearchListBox::MapSearchListBox(std::weak_ptr<MapDocument> document, MapView *mapView, Inspector *inspector, QWidget *parent) : ControlListBox("", false, parent), m_document(std::move(document)), m_mapView(mapView), m_inspector(inspector) {
