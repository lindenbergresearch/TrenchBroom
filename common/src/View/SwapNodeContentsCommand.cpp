...
namespace View {
SwapNodeContentsCommand::SwapNodeContentsCommand(const std::string &name, std::vector<std::pair<Model::Node *, Model::NodeContents>> nodes) : UpdateLinkedGroupsCommandBase(name, true), m_nodes(std::move(nodes)) {
}
