...
MousePreferencePane::MousePreferencePane(QWidget *parent) :
    PreferencePane(parent), m_lookSpeedSlider(nullptr), m_invertLookHAxisCheckBox(nullptr), m_invertLookVAxisCheckBox(nullptr), m_panSpeedSlider(nullptr),
    m_invertPanHAxisCheckBox(nullptr), m_invertPanVAxisCheckBox(nullptr), m_moveSpeedSlider(nullptr), m_invertMouseWheelCheckBox(nullptr),
    m_enableAltMoveCheckBox(nullptr), m_invertAltMoveAxisCheckBox(nullptr), m_moveInCursorDirCheckBox(nullptr), m_forwardKeyEditor(nullptr),
    m_backwardKeyEditor(nullptr), m_leftKeyEditor(nullptr), m_rightKeyEditor(nullptr), m_upKeyEditor(nullptr), m_downKeyEditor(nullptr),
...
void MousePreferencePane::bindEvents() {
  ...
  connect(
      m_mouseSmoothingSlider, &SliderWithLabel::valueChanged, this, &MousePreferencePane::mouseSmoothingChanged
  );
  connect(
...
void MousePreferencePane::flyMoveSpeedChanged(const int /* value */) {
  ...
  PreferenceManager &prefs = PreferenceManager::instance();
  prefs.set(
      Preferences::CameraFlyMoveSpeed, std::max(ratio, Preferences::MinCameraFlyMoveSpeed));
}
