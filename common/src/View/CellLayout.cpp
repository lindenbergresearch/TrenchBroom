...
LayoutCell::LayoutCell(
    ...
    : m_x{x}, m_y{y}, m_itemWidth{itemWidth}, m_itemHeight{itemHeight}, m_titleWidth{titleWidth},
      m_titleHeight{titleHeight}, m_titleMargin{titleMargin} {
...
LayoutGroup::LayoutGroup(
    ...
    const float minCellHeight,
    const float maxCellHeight)
    : m_item{std::move(item)}, m_cellMargin{cellMargin}, m_titleMargin{titleMargin}, m_rowMargin{rowMargin},
      ...
      m_contentBounds{x, y + titleHeight + m_rowMargin, width, 0.0f}, m_rows{} {
}
...
LayoutGroup::LayoutGroup(
    ...
    : m_cellMargin{cellMargin}, m_titleMargin{titleMargin}, m_rowMargin{rowMargin}, m_maxCellsPerRow{maxCellsPerRow},
      ...
      m_contentBounds{x, y, width, 0.0f}, m_rows{} {
}
...
CellLayout::CellLayout(const size_t maxCellsPerRow)
    : m_width{1.0f}, m_cellMargin{0.0f}, m_titleMargin{0.0f}, m_rowMargin{0.0f}, m_groupMargin{0.0f},
      m_outerMargin{0.0f}, m_maxCellsPerRow{maxCellsPerRow}, m_maxUpScale{1.0f}, m_minCellWidth{100.0f},
      m_maxCellWidth{100.0f}, m_minCellHeight{100.0f}, m_maxCellHeight{100.0f}, m_groups{}, m_valid{false},
      m_height{0.0f} {
    invalidate();
}
