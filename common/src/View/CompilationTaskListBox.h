...
class CompilationTaskEditorBase : public ControlListBoxItemRenderer {
  ...
  protected:
    CompilationTaskEditorBase(QString title, std::weak_ptr<MapDocument> document, Model::CompilationProfile &profile, Model::CompilationTask &task, QWidget *parent);
...
class CompilationExportMapTaskEditor : public CompilationTaskEditorBase {
  ...
  public:
    CompilationExportMapTaskEditor(std::weak_ptr<MapDocument> document, Model::CompilationProfile &profile, Model::CompilationTask &task, QWidget *parent = nullptr);
...
class CompilationCopyFilesTaskEditor : public CompilationTaskEditorBase {
  ...
  public:
    CompilationCopyFilesTaskEditor(std::weak_ptr<MapDocument> document, Model::CompilationProfile &profile, Model::CompilationTask &task, QWidget *parent = nullptr);
...
class CompilationRenameFileTaskEditor : public CompilationTaskEditorBase {
  ...
  public:
    CompilationRenameFileTaskEditor(std::weak_ptr<MapDocument> document, Model::CompilationProfile &profile, Model::CompilationTask &task, QWidget *parent = nullptr);
...
class CompilationDeleteFilesTaskEditor : public CompilationTaskEditorBase {
  ...
  public:
    CompilationDeleteFilesTaskEditor(std::weak_ptr<MapDocument> document, Model::CompilationProfile &profile, Model::CompilationTask &task, QWidget *parent = nullptr);
...
class CompilationRunToolTaskEditor : public CompilationTaskEditorBase {
  ...
  public:
    CompilationRunToolTaskEditor(std::weak_ptr<MapDocument> document, Model::CompilationProfile &profile, Model::CompilationTask &task, QWidget *parent = nullptr);
