...
SECTION("Passing a brush with selected faces to constructor clears the brushes face "
"selection")
{
REQUIRE(!brush.
...
SECTION("Setting a brush with selected faces correctly updates the node's face selection "
"count")
{
REQUIRE(!brush.
