...
TEST_CASE_METHOD(EditorContextTest, "EditorContextTest.testTopLevelNodes")
{
    ...
    SECTION("World")
    {
        ...
        // clang-format off
        const auto [wrldVisState, wrldLckState, visible, editable, selectable] = GENERATE(values<T>({{V_Shown,  L_Locked,   true,  false, false},
    ...
    SECTION("Layer")
    {
        ...
        // clang-format off
        const auto [wrldVisState, wrldLckState, layrVisState, layrLckState, visible, editable, selectable] = GENERATE(values<T>(
    ...
    SECTION("Top Level Group")
    {
        ...
        // clang-format off
        const auto [wrldVisState, wrldLckState, open, selected, grpVisState, grpLckState, childVisState, visible, editable, selectable] = GENERATE(values<T>(
    ...
    SECTION("Top Level Brush Entity, Patch Entity")
    {
        ...
        // clang-format off
        const auto [wrldVisState, wrldLckState, entVisState, entLockState, childVisState, visible, editable, selectable] = GENERATE(values<T>(
    ...
    SECTION("Top Level Point Entity")
    {
        ...
        // clang-format off
        const auto [wrldVisState, wrldLckState, prefValue, entVisState, entLckState, visible, editable, selectable] = GENERATE(values<T>(
    ...
    SECTION("Top Level Brush, Patch")
    {
        ...
        // clang-format off
        const auto [wrldVisState, wrldLckState, nodeVisState, nodeLckState, visible, editable, selectable] = GENERATE(values<T>(
...
TEST_CASE_METHOD(EditorContextTest, "EditorContextTest.testGroupedNodes")
{
    SECTION("Nested group")
    {
        ...
        // clang-format off
        const auto [outOpen, innOpen, outSel, innSel, outVisState, outLckState, innVisState, innLckState, visible, editable, selectable] = GENERATE(values<T>(
    ...
    SECTION("Grouped Point Entity, Grouped Brush, Grouped Patch")
    {
        ...
        // clang-format off
        const auto [grpOpen, grpVisState, grpLckState, entVisState, entLckState, visible, editable, selectable] = GENERATE(values<T>(
    ...
    SECTION("Grouped Brush Entity, Patch Entity")
    {
        ...
        // clang-format off
        const auto [grpOpen, grpVisState, grpLckState, entVisState, entLockState, childVisState, visible, editable, selectable] = GENERATE(values<T>(
