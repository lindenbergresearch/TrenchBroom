...
const auto nodeTestVisitor = kdl::overload([](WorldNode *) { return Visited::World; }, [](LayerNode *) { return Visited::Layer; },
    [](GroupNode *) { return Visited::Group; }, [](EntityNode *) { return Visited::Entity; }, [](BrushNode *) { return Visited::Brush; },
    [](PatchNode *) { return Visited::Patch; }
);

const auto constNodeTestVisitor = kdl::overload([](const WorldNode *) { return Visited::World; }, [](const LayerNode *) { return Visited::Layer; },
    [](const GroupNode *) { return Visited::Group; }, [](const EntityNode *) { return Visited::Entity; }, [](const BrushNode *) { return Visited::Brush; },
...
static auto makeCollectVisitedNodesVisitor(std::vector<Node *> &visited) {
    return kdl::overload([&](WorldNode *world) { visited.push_back(world); }, [&](LayerNode *layer) { visited.push_back(layer); },
