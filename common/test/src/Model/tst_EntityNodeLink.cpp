...
sourceNode->
setEntity(Entity({}, {{EntityPropertyKeys::Target, "target_name"}})
);

targetNode->
setEntity(Entity({}, {{EntityPropertyKeys::Targetname, "target_name"}})
);
...
EntityNode *targetNode = new Model::EntityNode(Model::Entity());
world.defaultLayer()->
addChild(sourceNode1);
world.defaultLayer()->
addChild(sourceNode2);
world.defaultLayer()->
addChild(targetNode);
...
targetNode1->
setEntity(Entity({}, {{EntityPropertyKeys::Targetname, "target_name1"}})
);

targetNode2->
setEntity(Entity({}, {{EntityPropertyKeys::Targetname, "target_name2"}})
);
...
sourceNode->
setEntity(Entity({}, {{EntityPropertyKeys::Target, "other_name"}})
);
...
targetNode->
setEntity(Entity({}, {{EntityPropertyKeys::Targetname, "other_name"}})
);
...
sourceNode->
setEntity(Entity({}, {{EntityPropertyKeys::Killtarget, "target_name"}})
);
...
sourceNode->
setEntity(Entity({}, {{EntityPropertyKeys::Killtarget, "other_name"}})
);
