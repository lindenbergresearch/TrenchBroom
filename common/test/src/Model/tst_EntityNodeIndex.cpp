...
TEST_CASE("EntityNodeIndexTest.addProperty")
{
    ...
    entity2->setEntity(Entity({}, {{"test",  "somevalue"},
                                   {"other", "someothervalue"},
        }
    ));
...
TEST_CASE("EntityNodeIndexTest.addNumberedEntityProperty")
{
    ...
    EntityNode *entity1 = new EntityNode({}, {{"test1", "somevalue"},
                                              {"test2", "somevalue"}}
    );
...
TEST_CASE("EntityNodeIndexTest.allValuesForKeys")
{
    ...
    EntityNode *entity2 = new EntityNode({}, {{"test",  "somevalue2"},
                                              {"other", "someothervalue"}}
    );
    ...
    CHECK_THAT(index.allValuesForKeys(EntityNodeIndexQuery::exact("test")), Catch::UnorderedEquals(std::vector<std::string>{
