...
TEST_CASE("BrushTest.movePointRemainingPolygon")
{
    ...
    assertCanMoveVertex(brush, peakPosition, vm::vec3(256.0, 0.0, -129.0)); // Flips the normal of the base
...
TEST_CASE("BrushTest.movePolygonRemainingPolygon_DisallowVertexCombining")
{
    ...
    assertCanMoveFace(brush, topFaceIndex, vm::vec3(0, 0, -128)); // Merge 2 verts of the moving polygon with 2 in the
...
TEST_CASE("moveFaceWithUVLock")
{
    ...
    for (auto &oldFace: brush.faces()) {
        ...
        // faces, but not on others
        {
            ...
            if (normal == vm::vec3::pos_z() || normal == vm::vec3::pos_y() || normal == vm::vec3::neg_y()) {
