...
static bool canMoveBoundary(Brush brush, const vm::bbox3 &worldBounds, const size_t faceIndex, const vm::vec3 &delta) {
    return brush.moveBoundary(worldBounds, faceIndex, delta, false).transform([&]() { return worldBounds.contains(brush.bounds()); }).value_or(false);
}
...
findFace (vm::vec3::pos_y())

);
CHECK(brush
.

findFace (vm::vec3::neg_y())
...
CHECK(Brush::create(worldBounds, {
    createParaxial(vm::vec3(0.0, 0.0, 0.0), vm::vec3(1.0, 0.0, 0.0), vm::vec3(0.0, 1.0, 0.0)), createParaxial(vm::vec3(0.0, 0.0, 0.0), vm::vec3(1.0, 0.0, 0.0), vm::vec3(0.0, 1.0, 0.0)), createParaxial(vm::vec3(0.0, 0.0, 0.0), vm::vec3(1.0, 0.0, 0.0), vm::vec3(0.0, 1.0, 0.0)),
})
.
...
const auto left = createParaxial(vm::vec3(0.0, 0.0, 0.0), vm::vec3(0.0, 1.0, 0.0), vm::vec3(0.0, 0.0, 1.0));
const auto right = createParaxial(vm::vec3(16.0, 0.0, 0.0), vm::vec3(16.0, 0.0, 1.0), vm::vec3(16.0, 1.0, 0.0));
const auto front = createParaxial(vm::vec3(0.0, 0.0, 0.0), vm::vec3(0.0, 0.0, 1.0), vm::vec3(1.0, 0.0, 0.0));
const auto back = createParaxial(vm::vec3(0.0, 16.0, 0.0), vm::vec3(1.0, 16.0, 0.0), vm::vec3(0.0, 16.0, 1.0));
const auto top = createParaxial(vm::vec3(0.0, 0.0, 16.0), vm::vec3(0.0, 1.0, 16.0), vm::vec3(1.0, 0.0, 16.0));
const auto bottom = createParaxial(vm::vec3(0.0, 0.0, 0.0), vm::vec3(1.0, 0.0, 0.0), vm::vec3(0.0, 1.0, 0.0));

// build a cube with length 16 at the origin
Brush brush = Brush::create(worldBounds, {left, right, front, back, top, bottom}).value();

BrushFace clip = createParaxial(vm::vec3(8.0, 0.0, 0.0), vm::vec3(8.0, 0.0, 1.0), vm::vec3(8.0, 1.0, 0.0));
CHECK(brush
.
clip(worldBounds, clip
).
...
CHECK(!
canMoveBoundary(brush, worldBounds, *topFaceIndex, vm::vec3(0.0, 0.0, -16.0)
));
CHECK(canMoveBoundary(brush, worldBounds, *topFaceIndex, vm::vec3(0.0, 0.0, +2.0))
);
CHECK(!
canMoveBoundary(brush, worldBounds, *topFaceIndex, vm::vec3(0.0, 0.0, -6.0)
));
...
CHECK(brush
.
moveBoundary(worldBounds, *topFaceIndex, vm::vec3(0.0, 0.0, 1.0),
false).
...
Brush brush1 = builder.createBrush(std::vector<vm::vec3>{
    vm::vec3(64, -64, 16), vm::vec3(64, 64, 16), vm::vec3(64, -64, -16), vm::vec3(64, 64, -16), vm::vec3(48, 64, 16), vm::vec3(48, 64, -16)
}, "texture").value();
...
CHECK(!
canMoveBoundary(brush1, worldBounds, *rightFaceIndex, vm::vec3(8000, 0, 0)
));
}
...
vertexPositions(), Catch::UnorderedEquals(expectedVertices)
...
CHECK(brush
.
moveVertices(worldBounds, oldVertexPositions, p9
- p8).
...
CHECK(newVertexPositions
.

size()

== 1u);
CHECK(newVertexPositions[0]
==
vm::approx(p9)
);
...
CHECK(brush
.
moveVertices(worldBounds, oldVertexPositions, p8
- p9).
...
points.
push_back(vm::vec3(-16.0, -16.0, 0.0)
);
points.
push_back(vm::vec3(+16.0, -16.0, 0.0)
);
points.
push_back(vm::vec3(0.0, +16.0, 0.0)
);
points.
push_back(top);
...
CHECK(brush
.
moveVertices(worldBounds, oldVertexPositions, delta
).
...
CHECK(newVertexPositions[0]
==
vm::approx(vm::vec3(0.0, 0.0, -16.0)
));
CHECK(brush
.
...
CHECK(brush
.
hasEdge(vm::segment3d(p1, p2)
));
CHECK(brush
.
hasEdge(vm::segment3d(p1, p3)
));
CHECK(brush
.
hasEdge(vm::segment3d(p1, p5)
));
CHECK(brush
.
hasEdge(vm::segment3d(p2, p4)
));
CHECK(brush
.
hasEdge(vm::segment3d(p2, p6)
));
CHECK(brush
.
hasEdge(vm::segment3d(p3, p4)
));
CHECK(brush
.
hasEdge(vm::segment3d(p3, p7)
));
CHECK(brush
.
hasEdge(vm::segment3d(p4, p6)
));
CHECK(brush
.
hasEdge(vm::segment3d(p4, p7)
));
CHECK(brush
.
hasEdge(vm::segment3d(p4, p9)
));
CHECK(brush
.
hasEdge(vm::segment3d(p5, p6)
));
CHECK(brush
.
hasEdge(vm::segment3d(p5, p7)
));
CHECK(brush
.
hasEdge(vm::segment3d(p6, p7)
));
CHECK(brush
.
hasEdge(vm::segment3d(p6, p9)
));
CHECK(brush
.
hasEdge(vm::segment3d(p7, p9)
));
...
CHECK(brush
.
hasFace(vm::polygon3d({p1, p5, p6, p2})
));
CHECK(brush
.
hasFace(vm::polygon3d({p1, p2, p4, p3})
));
CHECK(brush
.
hasFace(vm::polygon3d({p1, p3, p7, p5})
));
CHECK(brush
.
hasFace(vm::polygon3d({p2, p6, p9})
));
CHECK(brush
.
hasFace(vm::polygon3d({p2, p9, p4})
));
CHECK(brush
.
hasFace(vm::polygon3d({p3, p4, p9})
));
CHECK(brush
.
hasFace(vm::polygon3d({p3, p9, p7})
));
CHECK(brush
.
hasFace(vm::polygon3d({p5, p9, p6})
));
CHECK(brush
.
hasFace(vm::polygon3d({p5, p7, p9})
));
}
...
CHECK(brush
.
hasFace(vm::polygon3d({p2, p6, p9, p4})
));
CHECK(brush
.
hasFace(vm::polygon3d({p5, p7, p6})
));
CHECK(brush
.
hasFace(vm::polygon3d({p3, p4, p7})
));
CHECK(brush
.
hasFace(vm::polygon3d({p9, p6, p7})
));
CHECK(brush
.
hasFace(vm::polygon3d({p9, p7, p4})
));
}
...
CHECK(brush
.
hasFace(vm::polygon3d({p5, p7, p9, p6})
));
CHECK(brush
.
hasFace(vm::polygon3d({p3, p4, p9, p7})
));
CHECK(brush
.
hasFace(vm::polygon3d({p2, p6, p4})
));
CHECK(brush
.
hasFace(vm::polygon3d({p9, p4, p6})
));
}
...
CHECK(brush
.
hasEdge(vm::segment3d(p3, p5)
));
CHECK(brush
.
hasEdge(vm::segment3d(p3, p8)
));
CHECK(brush
.
hasEdge(vm::segment3d(p4, p8)
));
CHECK(brush
.
hasEdge(vm::segment3d(p5, p6)
...
CHECK(brush
.
hasEdge(vm::segment3d(p5, p8)
));
CHECK(brush
.
hasEdge(vm::segment3d(p6, p8)
));
...
CHECK(brush
.
hasFace(vm::polygon3d({p2, p6, p8, p4})
));
CHECK(brush
.
hasFace(vm::polygon3d({p1, p3, p5})
));
CHECK(brush
.
hasFace(vm::polygon3d({p3, p4, p8})
));
CHECK(brush
.
hasFace(vm::polygon3d({p5, p8, p6})
));
CHECK(brush
.
hasFace(vm::polygon3d({p3, p8, p5})
));
}
...
CHECK(brush
.
hasFace(vm::polygon3d({p1, p5, p2})
));
CHECK(brush
.
hasFace(vm::polygon3d({p2, p5, p9})
));
CHECK(brush
.
hasFace(vm::polygon3d({p2, p9, p4})
...
CHECK(brush
.
hasFace(vm::polygon3d({p1, p5, p9, p2})
));
CHECK(brush
.
hasFace(vm::polygon3d({p2, p9, p4})
...
CHECK(brush
.
hasFace(vm::polygon3d({p3, p4, p8, p7})
));
CHECK(brush
.
hasFace(vm::polygon3d({p5, p7, p8, p6})
));
}
...
CHECK(brush
.
canMoveVertices(worldBounds, allVertexPositions, vm::vec3(16, 0, 0)
));
CHECK_FALSE(brush
.
canMoveVertices(worldBounds, allVertexPositions, vm::vec3(8192, 0, 0)
));
}
...
const std::vector<vm::vec3> baseQuadVertexPositions{
    ...
    vm::vec3(-64.0, +64.0, -64.0), vm::vec3(+64.0, +64.0, -64.0), vm::vec3(+64.0, -64.0, -64.0)
};
const std::vector<vm::vec3> vertexPositions = kdl::vec_concat(std::vector<vm::vec3>{
    peakPosition
...
assertCanNotMoveVertex(brush, peakPosition, vm::vec3(0.0, 0.0, -128.0)
); // Onto the base quad plane
assertCanMoveVertex(brush, peakPosition, vm::vec3(0.0, 0.0, -129.0)
); // Through the other side of the base quad
...
CHECK(brushCopy
.
findFace(vm::polygon3(baseQuadVertexPositions)
));
CHECK_FALSE(brushCopy
.
findFace(vm::polygon3(flippedBaseQuadVertexPositions)
));
CHECK(brushCopy
.
...
CHECK(brushCopy
.
canMoveVertices(worldBounds, oldVertexPositions, delta
));
REQUIRE(brushCopy
.
moveVertices(worldBounds, oldVertexPositions, delta
...
assertCanNotMoveVertex(brush, peakPosition, vm::vec3(256.0, 0.0, -128.0)
); // Onto the base quad plane
assertCanMoveVertex(brush, peakPosition, vm::vec3(256.0, 0.0, -129.0)
); // Flips the normal of the base
...
const std::vector<vm::vec3> vertexPositions{
    ...
    vm::vec3(-64.0, +64.0, 0.0), vm::vec3(+64.0, +64.0, 0.0), vm::vec3(+64.0, -64.0, 0.0), vm::vec3(-64.0, -64.0, 64.0), // upper quad
    vm::vec3(-64.0, +64.0, 64.0), vm::vec3(+64.0, +64.0, 64.0), vm::vec3(+64.0, -64.0, 64.0), peakPosition
};

BrushBuilder builder(MapFormat::Standard, worldBounds);
Brush brush = builder.createBrush(vertexPositions, Model::BrushFaceAttributes::NoTextureName).value();

assertMovingVertexDeletes(brush, peakPosition, vm::vec3(0.0, 0.0, -65.0)
); // Move inside the remaining cuboid
assertCanMoveVertex(brush, peakPosition, vm::vec3(0.0, 0.0, -63.0)
); // Slightly above the top of the cuboid is OK
assertCanNotMoveVertex(brush, peakPosition, vm::vec3(0.0, 0.0, -129.0)
); // Through and out the other side is disallowed
}
...
CHECK(brush
.
removeVertices(worldBounds, std::vector<vm::vec3>(1, vm::vec3(+32.0, +32.0, +32.0))
).
...
CHECK(brush
.
hasVertex(vm::vec3(-32.0, -32.0, -32.0)
));
CHECK(brush
.
hasVertex(vm::vec3(-32.0, -32.0, +32.0)
...
CHECK_FALSE(brush
.
canRemoveVertices(worldBounds, std::vector<vm::vec3>(1, vm::vec3(-32.0, -32.0, +32.0))
));
CHECK_FALSE(brush
.
canRemoveVertices(worldBounds, std::vector<vm::vec3>(1, vm::vec3(-32.0, +32.0, -32.0))
...
vertices.
push_back(vm::vec3(-32.0, -32.0, -32.0)
);
vertices.
push_back(vm::vec3(-32.0, -32.0, +32.0)
);
...
toRemove.
push_back(vertices[j]);
toRemove.
push_back(vertices[k]);

Brush brush = builder.createBrush(vertices, "asdf").value();
CHECK(brush
.
canRemoveVertices(worldBounds, toRemove
));
CHECK(brush
.
removeVertices(worldBounds, toRemove
).
...
CHECK(brush
.
moveEdges(worldBounds, oldEdgePositions, delta
).

is_success()

);
auto newEdgePositions = brush.findClosestEdgePositions(kdl::vec_transform(oldEdgePositions, [&](const auto &s) { return s.translate(delta); }));

CHECK(newEdgePositions
.

size()

== 1u);
CHECK(newEdgePositions[0]
==
vm::segment3(p1_2, p2_2
));
...
CHECK(brush
.
canMoveEdges(worldBounds, newEdgePositions, p1
- p1_2));
...
newEdgePositions = brush.findClosestEdgePositions(kdl::vec_transform(oldEdgePositions, [&](const auto &s) { return s.translate(delta); }));
...
assertCanNotMoveEdges(brush, std::vector<vm::segment3>{edge}, vm::vec3(+64, 0, 0)
); // On the side of the cube
assertCanNotMoveEdges(brush, std::vector<vm::segment3>{edge}, vm::vec3(+128, 0, 0)
); // Center of the cube
...
assertCanNotMoveEdges(brush, movingEdges, vm::vec3(+64, 0, 0)
); // On the side of the cube
assertCanNotMoveEdges(brush, movingEdges, vm::vec3(+128, 0, 0)
); // Center of the cube
...
CHECK(brush
.
canMoveFaces(worldBounds, std::vector<vm::polygon3>(1, face), vm::vec3(-16.0, -16.0, 0.0)
));
...
CHECK(brush
.
moveFaces(worldBounds, oldFacePositions, delta
).
...
CHECK(newFacePositions
.

size()

== 1u);
CHECK(newFacePositions[0]
.
hasVertex(vm::vec3(-48.0, -48.0, +32.0)
));
CHECK(newFacePositions[0]
.
hasVertex(vm::vec3(-48.0, +16.0, +32.0)
));
CHECK(newFacePositions[0]
.
hasVertex(vm::vec3(+16.0, +16.0, +32.0)
));
CHECK(newFacePositions[0]
.
hasVertex(vm::vec3(+16.0, -48.0, +32.0)
));
...
CHECK_FALSE(brush
.
canMoveFaces(worldBounds, std::vector<vm::polygon3>(1, face), vm::vec3(0.0, 128.0, 0.0)
));
}
...
const std::vector<vm::vec3> vertexPositions{
    vm::vec3(+64.0, +64.0, +64.0), vm::vec3(+64.0, -64.0, +64.0), vm::vec3(+64.0, -64.0, -64.0), vm::vec3(+64.0, +64.0, -64.0), vm::vec3(-64.0, -64.0, +64.0), vm::vec3(-64.0, -64.0, -64.0), vm::vec3(-64.0, +64.0, -64.0), vm::vec3(-64.0, +64.0, +64.0)
};
...
==
vm::bbox3(vm::vec3(-64, -64, -64), vm::vec3(64, 64, 64)
));
...
const std::vector<vm::vec3> vertexPositions{
    ...
    vm::vec3(-64.0, +64.0, +192.0), vm::vec3(+64.0, -64.0, +64.0), vm::vec3(+64.0, +64.0, +64.0),
...
assertCanMoveFace(brush, topFaceIndex, vm::vec3(0, 0, -128)
); // Merge 2 verts of the moving polygon with 2 in the
...
const std::vector<vm::vec3> smallerTopPolygon{
    ...
    vm::vec3(-32.0, +32.0, +64.0), vm::vec3(+32.0, -32.0, +64.0), vm::vec3(+32.0, +32.0, +64.0)
};
...
const std::vector<vm::vec3> cubeBottomFace{
    ...
    vm::vec3(-64.0, +64.0, -192.0), vm::vec3(+64.0, -64.0, -192.0), vm::vec3(+64.0, +64.0, -192.0),
};

const std::vector<vm::vec3> vertexPositions = kdl::vec_concat(smallerTopPolygon, cubeTopFace, cubeBottomFace);
...
assertCanNotMoveTopFaceBeyond127UnitsDown(brush);
assertCanNotMoveTopFace(brush, vm::vec3(0.0, 0.0, -257.0)
...
assertCanNotMoveVertices(brush, smallerTopPolygon, vm::vec3(0, 0, -257)
...
assertCanMoveTopFace(brush, vm::vec3(-32.0, -32.0, 0.0)
...
const std::vector<vm::vec3> leftPolygon{
    // A
    vm::vec3(-32.0, -32.0, +64.0), vm::vec3(-32.0, +32.0, +64.0), vm::vec3(-32.0, +32.0, -64.0), vm::vec3(-32.0, -32.0, -64.0),
};
const std::vector<vm::vec3> bottomPolygon{
    // B
    vm::vec3(-32.0, -32.0, -64.0), vm::vec3(-32.0, +32.0, -64.0), vm::vec3(+0.0, +32.0, -64.0), vm::vec3(+0.0, -32.0, -64.0),
};
const std::vector<vm::vec3> bottomRightPolygon{
    // C
    vm::vec3(+0.0, -32.0, -64.0), vm::vec3(+0.0, +32.0, -64.0), vm::vec3(+32.0, +32.0, +0.0), vm::vec3(+32.0, -32.0, +0.0),
};

const std::vector<vm::vec3> vertexPositions = kdl::vec_concat(leftPolygon, bottomPolygon, bottomRightPolygon);
...
CHECK(brush
.
hasFace(vm::polygon3(leftPolygon)
));
CHECK(brush
.
hasFace(vm::polygon3(bottomPolygon)
));
CHECK(brush
.
hasFace(vm::polygon3(bottomRightPolygon)
));

assertCanMoveFaces(brush, std::vector<vm::polygon3>{
    vm::polygon3(leftPolygon), vm::polygon3(bottomPolygon)
}, vm::vec3(0, 0, 63)
);
assertCanNotMoveFaces(brush, std::vector<vm::polygon3>{
    vm::polygon3(leftPolygon), vm::polygon3(bottomPolygon)
}, vm::vec3(0, 0, 64)
); // Merges B and C
}
...
const std::vector<vm::polygon3> movingFaces{
    cubeTop.polygon(), cubeRight.polygon(), cubeFront.polygon(), cubeBack.polygon(),
};

assertCanMoveFaces(brush, movingFaces, vm::vec3(32, 0, 0)
); // away from `edge`
assertCanMoveFaces(brush, movingFaces, vm::vec3(-63, 0, 0)
); // towards `edge`, not touching
assertCanMoveFaces(brush, movingFaces, vm::vec3(-64, 0, 0)
); // towards `edge`, touching
assertCanMoveFaces(brush, movingFaces, vm::vec3(-65, 0, 0)
); // towards `edge`, covering
...
template<MapFormat F> class UVLockTest {
    MapFormat param = F;
};
...
REQUIRE(changed
.
moveFaces(worldBounds,
{
polygonToMove}, delta, false).

is_success()

);
REQUIRE(changedWithUVLock
.
moveFaces(worldBounds,
{
polygonToMove}, delta, true).
...
const auto oldTexCoords = kdl::vec_transform(oldFace.vertexPositions(), [&](auto x) { return oldFace.textureCoords(x); });
const auto shearedVertexPositions = kdl::vec_transform(oldFace.vertexPositions(), [&](auto x) { return M * x; });
...
const auto newTexCoords = kdl::vec_transform(shearedVertexPositions, [&](auto x) { return newFace.textureCoords(x); });
if (normal ==
...
const auto newTexCoordsWithUVLock = kdl::vec_transform(shearedVertexPositions, [&](auto x) { return newFaceWithUVLock.textureCoords(x); });
if (normal ==
...
const auto fragments = kdl::fold_results(minuend.subtract(MapFormat::Standard, worldBounds, defaultTexture, subtrahend)).value();
CHECK(fragments
.
...
: fragments) {
if (brush.
findFace(vm::plane3(32.0, vm::vec3::neg_x())
)) {
left = &brush;
}
else if (brush.
findFace(vm::plane3(32.0, vm::vec3::pos_x())
)) {
right = &brush;
}
else if (brush.
findFace(vm::plane3(16.0, vm::vec3::neg_x())
)) {
top = &brush;
}}
...
CHECK(left
->
findFace(vm::plane3(-16.0, vm::vec3::pos_x())
));
CHECK(left
->
findFace(vm::plane3(+32.0, vm::vec3::neg_x())
...
CHECK(left
->
findFace(vm::plane3(+16.0, vm::vec3::pos_y())
));
CHECK(left
->
findFace(vm::plane3(+16.0, vm::vec3::neg_y())
));
CHECK(left
->
findFace(vm::plane3(+32.0, vm::vec3::pos_z())
));
CHECK(left
->
findFace(vm::plane3(+32.0, vm::vec3::neg_z())
));
...
CHECK(top
->
findFace(vm::plane3(0.0, vm::vec3::neg_z())
));
...
CHECK_FALSE(brush1Bounds
.
intersects(brush2Bounds)
);
...
const auto fragments = kdl::fold_results(brush1.subtract(MapFormat::Standard, worldBounds, "texture", brush2)).value();
CHECK(fragments
.
...
CHECK_THAT(subtraction
.

vertexPositions(), Catch::UnorderedEquals(brush1.vertexPositions())
