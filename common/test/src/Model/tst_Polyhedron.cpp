...
TEST_CASE("PolyhedronTest.constructPolygonWithRedundantPoint")
{
    ...
    CHECK(p.hasAllVertices({
            vm::vec3{-64.0, 64.0, -16.0}, vm::vec3{64.0, 64.0, -16.0}, vm::vec3{22288.0, 18208.0, 16.0}, vm::vec3{22416.0, 18336.0, 16.0},
        }, 0.0
    ));
}
...
TEST_CASE("PolyhedronTest.subtractCuboidProtrudingThroughCuboid")
{
    ...
    const std::vector<vm::vec3d> leftVertices{
        vm::vec3d(-16, -32, -16), vm::vec3d(-16, 32, -16), vm::vec3d(-16, 32, 16), vm::vec3d(-16, -32, 16), vm::vec3d(-32, 32, 16), vm::vec3d(-32, -32, 16),
        vm::vec3d(-32, -32, -16), vm::vec3d(-32, 32, -16),
    };
    ...
    const std::vector<vm::vec3d> frontVertices{
        vm::vec3d(-16, -32, -16), vm::vec3d(-16, -32, 16), vm::vec3d(16, -16, -16), vm::vec3d(-16, -16, -16), vm::vec3d(-16, -16, 16), vm::vec3d(16, -16, 16),
        vm::vec3d(16, -32, 16), vm::vec3d(16, -32, -16)
    };
...
TEST_CASE("PolyhedronTest.subtractCuboidFromCuboidWithCutCorners")
{
    ...
    const Polyhedron3d minuend{
        vm::vec3d(-32.0, -8.0, 0.0), vm::vec3d(+32.0, -8.0, 0.0), vm::vec3d(+32.0, -8.0, 32.0), vm::vec3d(+16.0, -8.0, 48.0), vm::vec3d(-16.0, -8.0, 48.0),
        vm::vec3d(-32.0, -8.0, 32.0), vm::vec3d(-32.0, +8.0, 0.0), vm::vec3d(+32.0, +8.0, 0.0), vm::vec3d(+32.0, +8.0, 32.0), vm::vec3d(+16.0, +8.0, 48.0),
        vm::vec3d(-16.0, +8.0, 48.0), vm::vec3d(-32.0, +8.0, 32.0)
    };
    ...
    vm::parse_all<double, 3>("(-16 8 -0) (-16 8 48) (-16 -8 48) (-16 -8 -0) (-32 -8 -0) (-32 -8 32) (-32 8 -0) "
                             "(-32 8 32)", std::back_inserter(left));
...
TEST_CASE("PolyhedronTest.subtractRhombusFromCuboid")
{
    ...
    vm::parse_all<double, 3>("(-32.0 0.0 +96.0) (0.0 -32.0 +96.0) (+32.0 0.0 +96.0) (0.0 +32.0 +96.0) (-32.0 0.0 "
                             "-96.0) "
                             "(0.0 -32.0 -96.0) (+32.0 0.0 -96.0) (0.0 +32.0 -96.0)", std::back_inserter(subtrahendVertices));
    ...
    vm::parse_all<double, 3>("(-64 32 64) (-64 32 -64) (-32 -0 64) (-32 -0 -64) (-0 32 -64) (-0 32 64) (-64 64 "
                             "64) (-32 64 "
                             "-64) (-32 64 64) (-64 64 -64)", std::back_inserter(f2));
    vm::parse_all<double, 3>("(64 -32 64) (64 -32 -64) (64 -64 64) (64 -64 -64) (-0 -32 64) (32 -0 64) (32 -0 "
                             "-64) (-0 -32 "
                             "-64) (32 -64 -64) (32 -64 64)", std::back_inserter(f3));
...
TEST_CASE("PolyhedronTest.intersection_polygon_polyhedron_same_plane_as_face")
{
    const Polyhedron3d cube{
        vm::vec3d(-1.0, -1.0, -1.0), vm::vec3d(-1.0, -1.0, +1.0), vm::vec3d(-1.0, +1.0, -1.0), vm::vec3d(-1.0, +1.0, +1.0), vm::vec3d(+1.0, -1.0, -1.0),
        vm::vec3d(+1.0, -1.0, +1.0), vm::vec3d(+1.0, +1.0, -1.0), vm::vec3d(+1.0, +1.0, +1.0),
    };
