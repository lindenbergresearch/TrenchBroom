...
{
    const auto vertices = std::vector<vm::vec3>({
            vm::vec3d(-64, -64, -64), vm::vec3d(-64, -64, 64), vm::vec3d(-64, -32, 64), vm::vec3d(-32, -64, -64), vm::vec3d(-32, -64, 64), vm::vec3d(-32, -0, -64),
            vm::vec3d(-32, -0, 64), vm::vec3d(-0, -32, -64), vm::vec3d(-0, -32, 64), vm::vec3d(64, -64, -64),
        }
    );
...
{
    const auto vertices = std::vector<vm::vec3>({
            vm::vec3d(-32, -16, -32), vm::vec3d(-32, 16, -32), vm::vec3d(-32, 16, -0), vm::vec3d(-16, -16, -32), vm::vec3d(-16, -16, -0), vm::vec3d(-16, 16, -32),
            vm::vec3d(-16, 16, -0), vm::vec3d(32, -16, -32),
        }
    );
...
TEST_CASE("PolyhedronTest.convexHullWithFailingPoints8")
{
    ...
    const auto vertices = std::vector<vm::vec3>({
            ...
            vm::vec3d(-16, 6.6274169975893429, -0), vm::vec3d(-15.999999999999998, 9.2376043067828455, -0), vm::vec3d(-14.345207554102323, 8.2822094434885454, -0),
...
TEST_CASE("PolyhedronTest.badClip")
{
    ...
    vm::parse_all<double, 3>("(42.343111906757798 -24.90770936530231 48) (-5.6569680341747599 2.8051472462014218 "
                             "-48) "
                             ...
                             "48) "
                             "(-13.006693391918915 1.3907491999939996 -48)", std::back_inserter(polyVertices));
...
TEST_CASE("PolyhedronTest.clipWithInvalidSeam")
{
    ...
    Polyhedron3d poly{
        // create a huge cube
        8192.0 * vm::vec3d(-1.0, -1.0, -1.0), 8192.0 * vm::vec3d(-1.0, -1.0, +1.0), 8192.0 * vm::vec3d(-1.0, +1.0, -1.0), 8192.0 * vm::vec3d(-1.0, +1.0, +1.0),
        8192.0 * vm::vec3d(+1.0, -1.0, -1.0), 8192.0 * vm::vec3d(+1.0, -1.0, +1.0), 8192.0 * vm::vec3d(+1.0, +1.0, -1.0), 8192.0 * vm::vec3d(+1.0, +1.0, +1.0),
    };
    ...
    poly.clip(std::get<1>(
        vm::from_points(vm::vec3d(-483.0, 1777.0, 253.0), vm::vec3d(-459.0, 1579.0, -115.0), vm::vec3d(-183.0, 1692.0, 95.0)))); //  Assertion failure here!
...
TEST_CASE("PolyhedronTest.subtractFailWithMissingFragments")
{
    const std::vector<vm::vec3d> minuendVertices{
        vm::vec3d(-1056, 864, -192), vm::vec3d(-1024, 896, -192), vm::vec3d(-1024, 1073, -192), vm::vec3d(-1056, 1080, -192), vm::vec3d(-1024, 1073, -416),
        vm::vec3d(-1024, 896, -416), vm::vec3d(-1056, 864, -416), vm::vec3d(-1056, 1080, -416)
    };

    const std::vector<vm::vec3d> subtrahendVertices{
        vm::vec3d(-1088, 960, -288), vm::vec3d(-1008, 960, -288), vm::vec3d(-1008, 1024, -288), vm::vec3d(-1088, 1024, -288), vm::vec3d(-1008, 1024, -400),
        vm::vec3d(-1008, 960, -400), vm::vec3d(-1088, 960, -400), vm::vec3d(-1088, 1024, -400)
    };
...
TEST_CASE("PolyhedronTest.subtractTetrahedronFromCubeWithOverlappingFragments")
{
    ...
    vm::parse_all<double, 3>("(-32 -32 32) (32 -32 32) (32 32 32) (-32 32 32) (32 32 -32) (32 -32 -32) (-32 -32 "
                             "-32) (-32 "
                             "32 -32)", std::back_inserter(minuendVertices));
