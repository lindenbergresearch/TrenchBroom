...
assertModelDefinition<DefParser>(
    Assets::ModelSpecification{"maps/b_shell0.bsp", 0, 0}, ModelDefinition, DefModelDefinitionTemplate
);
assertModelDefinition<DefParser>(
    Assets::ModelSpecification{"maps/b_shell1.bsp", 0, 0}, ModelDefinition, DefModelDefinitionTemplate,
"{ 'spawnflags': 1 }");
}
...
assertModelDefinition<DefParser>(
    Assets::ModelSpecification{"maps/b_shell1.bsp", 1, 2}, ModelDefinition, DefModelDefinitionTemplate,
