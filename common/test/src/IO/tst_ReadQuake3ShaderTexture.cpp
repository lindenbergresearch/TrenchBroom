...
CHECK(
    readQuake3ShaderTexture("test/with_editor_image", *fs.openFile(texturePrefix / "test/with_editor_image").value(), fs)
...
CHECK(
    readQuake3ShaderTexture("test/with_shader_path", *fs.openFile(texturePrefix / "test/with_shader_path").value(), fs)
== Result <TextureInfo, ReadTextureError>{
TextureInfo{
"test/with_shader_path", 64, 64}});

CHECK(
    readQuake3ShaderTexture("test/with_light_image", *fs.openFile(texturePrefix / "test/with_light_image").value(), fs)
== Result <TextureInfo, ReadTextureError>{
TextureInfo{
"test/with_light_image", 128, 64}});

CHECK(
    readQuake3ShaderTexture("test/with_stage_map", *fs.openFile(texturePrefix / "test/with_stage_map").value(), fs)
== Result <TextureInfo, ReadTextureError>{
TextureInfo{
"test/with_stage_map", 64, 128}});

CHECK(
    readQuake3ShaderTexture("test/missing_extension", *fs.openFile(texturePrefix / "test/missing_extension").value(), fs)
== Result <TextureInfo, ReadTextureError>{
TextureInfo{
"test/missing_extension", 128, 128}});

CHECK(
    readQuake3ShaderTexture("test/different_extension", *fs.openFile(texturePrefix / "test/different_extension").value(), fs)
== Result <TextureInfo, ReadTextureError>{
TextureInfo{
