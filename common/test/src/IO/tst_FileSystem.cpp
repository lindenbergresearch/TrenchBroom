...
CHECK(
    fs
.find("does_not_exist", TraversalMode::Flat)
== Result <std::vector<std::filesystem::path>>{
Error{
"Path does not denote a directory: 'does_not_exist'"}});
CHECK(
    fs
.find("root_file.map", TraversalMode::Flat)
== Result <std::vector<std::filesystem::path>>{
Error{
...
CHECK(
    fs
.find("some_dir", TraversalMode::Flat)
== Result <std::vector<std::filesystem::path>>{
std::vector<std::filesystem::path>{
"some_dir/nested_dir",
"some_dir/some_dir_file_1.TXT",
...
CHECK(
    fs
.find("some_dir", TraversalMode::Recursive)
== Result <std::vector<std::filesystem::path>>{
std::vector<std::filesystem::path>{
"some_dir/nested_dir",
"some_dir/nested_dir/nested_dir_file_2.map",
