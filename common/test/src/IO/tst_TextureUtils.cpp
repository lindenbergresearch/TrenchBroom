...
const auto [prefixLength, path, expectedResult] = GENERATE(
    values<T>(
        {{1, "", ""}, {1, "textures", ""}, {1, "textures/e1m1", "e1m1"}, {1, "textures/e1m1/haha", "e1m1/haha"}, {1, "textures/e1m1/haha.jpg", "e1m1/haha"},
         {1, "textures/nesting/e1m1/haha.jpg", "nesting/e1m1/haha"}, {2, "textures/nesting/e1m1/haha.jpg", "e1m1/haha"},
