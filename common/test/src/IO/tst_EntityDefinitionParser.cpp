...
TEST_CASE("resolveInheritance.overrideMembersIfNotPresent")
{
    ...
    const auto expected = std::vector<EntityDefinitionClassInfo>({{
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point", "description", Color(1, 2, 3),
                                                                      vm::bbox3(-1, 1), baseModelDef, {}, {"base"}},
        }
    );
...
TEST_CASE("resolveInheritance.skipMembersIfPresent")
{
    ...
    const auto expected = std::vector<EntityDefinitionClassInfo>({{
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point", "blah blah", Color(2, 3, 4),
                                                                      vm::bbox3(-2, 2), std::nullopt, {}, {"base"}},
        }
    );
...
TEST_CASE("resolveInheritance.mergeModelDefinitions")
{
    ...
    const auto expected = std::vector<EntityDefinitionClassInfo>({{
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point", std::nullopt, std::nullopt,
                                                                      std::nullopt, mergedModelDef, {}, {"base"}},
        }
    );
...
TEST_CASE("resolveInheritance.inheritPropertyDefinitions")
{
    ...
    const auto expected = std::vector<EntityDefinitionClassInfo>({{
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point", std::nullopt, std::nullopt,
                                                                      std::nullopt, std::nullopt, {a1_2, a3, a2}, {"base"}},
        }
    );
...
TEST_CASE("resolveInheritance.mergeSpawnflagsSimpleInheritance")
{
    ...
    CHECK_THAT(options, Catch::Equals(std::vector<Assets::FlagsPropertyOption>({{1 << 1, "a1_1", "", true},
                                                                                {1 << 2, "a2_2", "", true},
                                                                                {1 << 4, "a2_4", "", false},
        }
    )));
...
TEST_CASE("resolveInheritance.chainOfBaseClasses")
{
    ...
    const auto input = std::vector<EntityDefinitionClassInfo>({
            ...
            {EntityDefinitionClassType::BaseClass,  0, 0, "base2", "base2",      Color(1, 2, 3), std::nullopt,     base2ModelDef, {a1_2, a3}, {"base1"}},
            {EntityDefinitionClassType::PointClass, 0, 0, "point", std::nullopt, std::nullopt,   std::nullopt,     pointModelDef, {},         {"base2"}},
        }
    );
    const auto expected = std::vector<EntityDefinitionClassInfo>({{
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point", "base2", Color(1, 2, 3),
                                                                      vm::bbox3(-2, 2), mergedModelDef, {a1_2, a3, a2}, {"base2"}},
        }
    );
...
TEST_CASE("resolveInheritance.multipleBaseClasses")
{
    ...
    const auto expected = std::vector<EntityDefinitionClassInfo>({{
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point", "base1", Color(1, 2, 3),
                                                                      vm::bbox3(-2, 2), mergedModelDef, {a1_1, a2, a3}, {"base1", "base2"}},
        }
    );
...
TEST_CASE("resolveInheritance.diamondInheritance")
{
    ...
    const auto expected = std::vector<EntityDefinitionClassInfo>({{
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point1", "base2_1", Color(1, 2, 3
            ),                                                           vm::bbox3(-2, 2
            ),                                                                             std::nullopt, {a3, a2_1, a1, a2_2}, {"base2_1", "base2_2"}},
                                                                  {
                                                                      EntityDefinitionClassType::PointClass, 0, 0, "point2", "base2_2", Color(1, 2, 3
                                                                  ), vm::bbox3(-1, 1), std::nullopt, {a3, a2_2, a1, a2_1}, {"base2_2", "base2_1"}},
        }
    );
