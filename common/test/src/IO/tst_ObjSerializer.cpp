...
TEST_CASE("ObjSerializer.writeRelativeMaterialPath")
{
    ...
    const auto [options, textureAbsolutePath, expectedPath] = GENERATE(values<T>(
        {{{"/home/that_guy/quake/export/file.obj", ObjMtlPathMode::RelativeToExportPath}, "/home/that_guy/quake/textures/some_texture.png", "../textures/some_texture.png"},
         {{"/home/that_guy/quake/export/file.obj", ObjMtlPathMode::RelativeToExportPath}, "",                                               std::nullopt},
         {{"/home/that_guy/quake/export/file.obj", ObjMtlPathMode::RelativeToGamePath},   "/home/that_guy/quake/textures/some_texture.png", "textures/some_texture.png"},
        }
    ));
