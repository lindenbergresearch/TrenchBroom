...
const auto basePath = std::filesystem::current_path() / "fixture/test/IO/Ase/steelstorm_player";
fs.mount("",
...
const auto basePath = std::filesystem::current_path() / "fixture/test/IO/Ase/no_scene_directive";
fs.mount("",
std::make_unique<DiskFileSystem>(basePath)
);
...
const auto basePath = std::filesystem::current_path() / "fixture/test/IO/Ase/index_out_of_bounds";
fs.mount("",
std::make_unique<DiskFileSystem>(basePath)
);
