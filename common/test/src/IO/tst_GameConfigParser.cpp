...
"Trigger", {
Model::TagAttribute{
1u, "transparent"}}, std::make_unique<Model::EntityClassNameTagMatcher>("trigger*", "")
}, Model::SmartTag{
"Clip", {
Model::TagAttribute{
1u, "transparent"}}, std::make_unique<Model::TextureNameTagMatcher>("clip")
}, Model::SmartTag{
"Skip", {
Model::TagAttribute{
1u, "transparent"
...
"Hint", {
Model::TagAttribute{
1u, "transparent"}}, std::make_unique<Model::TextureNameTagMatcher>("hint*")
}, Model::SmartTag{
"Liquid", {
}, std::make_unique<Model::TextureNameTagMatcher>("\\**")
},
},            // smart tags
...
Model::FileSystemConfig{
{
"baseq2"}, Model::PackageFormatConfig{
{
".pak"}, "idpak"}},
Model::TextureConfig{
{
"textures"}, {
".wal"}, {
"pics/colormap.pcx"}, "_tb_textures", {
}, {
},},
Model::EntityConfig{
{
...
Model::BrushFaceAttributes{
Model::BrushFaceAttributes::NoTextureName}}, {
Model::SmartTag{
"Trigger", {
Model::TagAttribute{
1u, "transparent"}}, std::make_unique<Model::EntityClassNameTagMatcher>("trigger*", "trigger")
}, Model::SmartTag{
"Clip", {
Model::TagAttribute{
1u, "transparent"}}, std::make_unique<Model::TextureNameTagMatcher>("clip")
...
"Detail", {
}, std::make_unique<Model::ContentFlagsTagMatcher>(1 << 27)
}, Model::SmartTag{
"Liquid", {
...
setOffset(vm::vec2f(0.0f, 0.0f)
);
expectedBrushFaceAttributes.
setScale(vm::vec2f(0.5f, 0.5f)
);
...
{
"baseq3"}, Model::PackageFormatConfig{
{
".pk3"}, "zip"}},
Model::TextureConfig{
{
...
{
"Extras.ent"}}, Color{
0.6f, 0.6f, 0.6f, 1.0f}, EL::Expression{
EL::ArrayExpression{
{
