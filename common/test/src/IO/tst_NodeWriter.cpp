...
{
Model::WorldNode map(
    {}, {{"message\\", "holy damn\\"}, {"message2", "holy damn\\\\"}, {"message3", "holy damn\\\\\\"},}, Model::MapFormat::Standard
);
...
REQUIRE(brush
.
transform(worldBounds, vm::rotation_matrix(vm::to_radians(15.0), vm::to_radians(22.0), vm::to_radians(89.0)),
false).
...
// clang-format off
const auto [mapFormat, expectedSerializationTemplate] = GENERATE(
    values<FormatInfo>(
        {{
...
auto patch = Model::BezierPatch{
    5, 3, {{- 64, - 64, 4, 0, 0}, {- 64, 0, 4, 0, - 0.25}, {- 64, 64, 4, 0, - 0.5}, {0, - 64, 4, 0.2, 0}, {0, 0, 4, 0.2, - 0.25}, {0, 64, 4, 0.2, - 0.5},
           {64, - 64, 4, 0.4, 0}, {64, 0, 4, 0.4, - 0.25}, {64, 64, 4, 0.4, - 0.5}, {128, - 64, 4, 0.6, 0}, {128, 0, 4, 0.6, - 0.25}, {128, 64, 4, 0.6, - 0.5},
