        ...
        "", {
            DirectoryEntry{
                "some_dir", {
                    DirectoryEntry{
                        "nested_dir", {
                            FileEntry{"nested_dir_file_1", nested_dir_file_1}, FileEntry{"nested_dir_file_2", nested_dir_file_2},
...
CHECK(
    fs
.makeAbsolute("some_dir/some_dir_file_1")
...
CHECK(
    fs
.find("some_dir/nested_dir", TraversalMode::Flat)
== Result <std::vector<std::filesystem::path>>{
std::vector<std::filesystem::path>{
