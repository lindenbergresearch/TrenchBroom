...
struct Param {
  ...
  Param(size_t &i_copyCount, size_t &i_moveCount) : copyCount{i_copyCount}, moveCount{i_moveCount} {
  }

  Param(const Param &other) : copyCount{other.copyCount}, moveCount{other.moveCount} {
      ++copyCount;
  }

  Param(Param &&other) noexcept: copyCount{other.copyCount}, moveCount{other.moveCount} {
      ++moveCount;
  }
};
