...
"UndoTest.setTexturesAfterRestore") {
document->
...
brushNode});
document->
translateObjects(vm::vec3(1, 1, 1)
);
CHECK(texture
->
...
rotateObjects(vm::vec3::zero(), vm::vec3::pos_z(), vm::to_radians(15.0)
