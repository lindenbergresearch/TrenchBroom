...
"asdf");
setLinkedGroupId(linkedGroupNode,
"asdf");
...
REQUIRE(helper
.applyLinkedGroupUpdates(*static_cast<MapDocumentCommandFacade *>(document.
...
helper.undoLinkedGroupUpdates(*static_cast<MapDocumentCommandFacade *>(document.
...
TEST_CASE_METHOD(UpdateLinkedGroupsHelperTest,
"UpdateLinkedGroupsHelperTest.applyLinkedGroupUpdates")
{
...
transformNode(*linkedGroupNode, vm::translation_matrix(vm::vec3(32.0, 0.0, 0.0)), document
->
...
.
translate(vm::vec3(32.0, 0.0, 0.0)
));
...
transformNode(*brushNode, vm::translation_matrix(vm::vec3(0.0, 16.0, 0.0)), document
->
...
== originalBrushBounds.
translate(vm::vec3(0.0, 16.0, 0.0)
));
...
CHECK(newLinkedBrushNode
->

physicalBounds()

== originalBrushBounds.
translate(vm::vec3(32.0, 16.0, 0.0)
));
...
== 1u);
CHECK_THAT(linkedGroupNode
->

children(), Catch::Equals(std::vector<Model::Node *>{linkedBrushNode})
...
setLinkedGroupId(*outerGroupNode,
"outerGroupNode");
...
setGroupName(*linkedInnerGroupNode,
"linkedInnerGroupNode");
REQUIRE(linkedInnerGroupNode
->
...
setGroupName(*linkedOuterGroupNode,
"linkedOuterGroupNode");
REQUIRE(linkedOuterGroupNode
->
...
setGroupName(*nestedLinkedInnerGroupNode,
"nestedLinkedInnerGroupNode");
REQUIRE(nestedLinkedInnerGroupNode
->
...
transformNode(*linkedOuterGroupNode, vm::translation_matrix(vm::vec3d(32.0, 0.0, 0.0)), document
->
...
transformNode(*innerGroupNode, vm::translation_matrix(vm::vec3d(0.0, 16.0, 0.0)), document
->
...
transformNode(*brushNode, vm::translation_matrix(vm::vec3d(0.0, 0.0, 8.0)), document
->
...
== originalBrushBounds.
translate(vm::vec3(0.0, 16.0, 8.0)
));
...
== originalBrushBounds.
translate(vm::vec3(0.0, 0.0, 8.0)
));

REQUIRE(nestedLinkedInnerGroupNode
!= nullptr);
CHECK(nestedLinkedInnerGroupNode
->
...
== originalBrushBounds.
translate(vm::vec3(32.0, 0.0, 8.0)
));
REQUIRE(nestedLinkedInnerGroupNode
->
...
CHECK(newNestedLinkedBrushNode
->
...
CHECK(newNestedLinkedInnerGroupNode
->
...
== originalBrushBounds.
translate(vm::vec3(32.0, 16.0, 8.0)
));
REQUIRE(newNestedLinkedInnerGroupNode
->
