    ...
    {
        {
            ...
            REQUIRE(helper.applyLinkedGroupUpdates(*static_cast<MapDocumentCommandFacade *>(document.get())).is_success());
        }
        CHECK(deleted);
    }
...
TEST_CASE_METHOD(UpdateLinkedGroupsHelperTest, "UpdateLinkedGroupsHelperTest.applyLinkedGroupUpdatesWithNestedLinkedGroups")
{
    ...
    */
    ...
    SECTION("First propagate changes to innerGroupNode, then outerGroupNode")
    {
        ...
        CHECK(helper1.applyLinkedGroupUpdates(*static_cast<MapDocumentCommandFacade *>(document.get())).is_success());
        ...
        */
        ...
        CHECK(helper2.applyLinkedGroupUpdates(*static_cast<MapDocumentCommandFacade *>(document.get())).is_success());
    ...
    SECTION("First propagate changes to outerGroupNode, then innerGroupNode")
    {
        ...
        REQUIRE(helper1.applyLinkedGroupUpdates(*static_cast<MapDocumentCommandFacade *>(document.get())).is_success());
        ...
        */
        ...
        REQUIRE(helper2.applyLinkedGroupUpdates(*static_cast<MapDocumentCommandFacade *>(document.get())).is_success());
