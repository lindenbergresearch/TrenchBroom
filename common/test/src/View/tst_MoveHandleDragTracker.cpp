...
namespace View {
template<typename Move, typename End, typename Cancel, typename Render, typename MakeHandleSnapper> struct TestDelegate : public MoveHandleDragTrackerDelegate {
  Move m_move;
  End m_end;
  Cancel m_cancel;
  Render m_render;
...
== DragState {
initialHandlePosition, initialHandlePosition, handleOffset
}
);
