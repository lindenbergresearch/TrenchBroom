...
TEST_CASE("CommandProcessorTest.doAndUndoSuccessfulCommand")
{
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandDo,       commandName},
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandUndo,       commandName},
...
TEST_CASE("CommandProcessorTest.commitUndoRedoTransaction")
{
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandDo,       commandName1},
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandUndo,       commandName2},
...
TEST_CASE("CommandProcessorTest.rollbackTransaction")
{
    ...
    CHECK(commandProcessor.executeAndStore(std::move(command2))->success());
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandDo,   commandName2},
                                                                                         {CommandNotif::CommandDone, commandName2},
        }
    ));
...
TEST_CASE("CommandProcessorTest.nestedTransactions")
{
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandDo,   outerCommandName},
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandDo,   innerCommandName},
                                                                                         {CommandNotif::CommandDone, innerCommandName},
        }
    ));

    commandProcessor.commitTransaction();
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::TransactionDone, innerTransactionName},}));

    commandProcessor.commitTransaction();
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::TransactionDone, outerTransactionName},}));
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandUndo,       innerCommandName},
...
TEST_CASE("CommandProcessorTest.collateCommands")
{
    ...
    CHECK_THAT(observer.popNotifications(), Catch::Equals(std::vector<NotificationTuple>{{CommandNotif::CommandUndo,       commandName1},
                                                                                         {CommandNotif::CommandUndone,     commandName1},
