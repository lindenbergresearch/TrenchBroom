...
static const std::array<MouseEvent::Type, 9> eventTypes = {
    MouseEvent::Type::Down, MouseEvent::Type::Up, MouseEvent::Type::Click, MouseEvent::Type::DoubleClick, MouseEvent::Type::Motion, MouseEvent::Type::Scroll,
    MouseEvent::Type::DragStart, MouseEvent::Type::Drag, MouseEvent::Type::DragEnd
};
...
checkEventQueue(r, MouseEvent(MouseEvent::Type::Down, MouseEvent::Button::Left, MouseEvent::WheelAxis::None, 2, 5, 0.0f),
...
r.
recordEvent(QMouseEvent(
    QEvent::MouseButtonPress, {
        2.0f, 5.0f
    }, {}, {}, Qt::LeftButton, Qt::LeftButton, Qt::MetaModifier
)
);
r.
recordEvent(QMouseEvent(QEvent::MouseButtonRelease, {2.0f, 5.0f}, {}, {}, Qt::LeftButton, Qt::LeftButton, 0)
...
checkEventQueue(r, MouseEvent(MouseEvent::Type::Down, MouseEvent::Button::Right, MouseEvent::WheelAxis::None, 2, 5, 0.0f),
...
r.
recordEvent(QMouseEvent(QEvent::MouseMove, {6.0f, 3.0f}, {}, {}, Qt::NoButton, Qt::NoButton, 0)
);
r.
recordEvent(QMouseEvent(QEvent::MouseMove, {12.0f, 8.0f}, {}, {}, Qt::NoButton, Qt::NoButton, 0)
);

checkEventQueue(r, MouseEvent(MouseEvent::Type::Motion, MouseEvent::Button::None, MouseEvent::WheelAxis::None, 12, 8, 0.0f)
);
}
...
checkEventQueue(r, MouseEvent(MouseEvent::Type::Scroll, MouseEvent::Button::None, MouseEvent::WheelAxis::Horizontal, 0, 0, expectedScrollLines)
);
}
...
checkEventQueue(r, MouseEvent(MouseEvent::Type::Scroll, MouseEvent::Button::None, MouseEvent::WheelAxis::Vertical, 0, 0, expectedScrollLines)
);
}
...
REQUIRE(expectedScrollLines2
.

x()

> 0.0f);
REQUIRE(0.0f == expectedScrollLines2.
...
checkEventQueue(r, MouseEvent(MouseEvent::Type::Down, MouseEvent::Button::Left, MouseEvent::WheelAxis::None, 2, 5, 0.0f),
    ...
    MouseEvent(MouseEvent::Type::Drag, MouseEvent::Button::Left, MouseEvent::WheelAxis::None, 6, 3, 0.0f), CancelEvent(),
