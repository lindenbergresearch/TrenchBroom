...
TEST_CASE("MouseEventTest.collateWith")
{
    static const std::array<MouseEvent::Type, 9> eventTypes = {
        MouseEvent::Type::Down, MouseEvent::Type::Up, MouseEvent::Type::Click, MouseEvent::Type::DoubleClick, MouseEvent::Type::Motion,
        MouseEvent::Type::Scroll, MouseEvent::Type::DragStart, MouseEvent::Type::Drag, MouseEvent::Type::DragEnd
    };
...
TEST_CASE("InputEventRecorderTest.recordCtrlLeftClick")
{
    ...
    r.recordEvent(QMouseEvent(QEvent::MouseButtonPress, {
            2.0f, 5.0f
...
TEST_CASE("InputEventRecorderTest.recordHScrollWithCollation")
{
    ...
    const float expectedScrollLines = static_cast<float>((
        InputEventRecorder::scrollLinesForEvent(qWheel1) + InputEventRecorder::scrollLinesForEvent(qWheel2)).x());
...
TEST_CASE("InputEventRecorderTest.recordVScrollWithCollation")
{
    ...
    const float expectedScrollLines = static_cast<float>((
        InputEventRecorder::scrollLinesForEvent(qWheel1) + InputEventRecorder::scrollLinesForEvent(qWheel2)).y());
    REQUIRE(expectedScrollLines > 0.0f);
