...
TEST_CASE_METHOD(MapDocumentTest, "CsgTest.csgConvexMergeFaces")
{
    ...
    document->selectBrushFaces({{brushNode1, faceIndex},
    ...
    const auto bounds = vm::merge(vm::bbox3::merge_all(std::begin(face1Verts), std::end(face1Verts)),
...
TEST_CASE("CsgTest.csgSubtractFailure")
{
    ...
    CHECK_THAT(result->brush().vertexPositions(), UnorderedApproxVecMatches(std::vector<vm::vec3>{{-2852,   372, 248},
                                                                                                  {-2854,   372, 256},
                                                                                                  {-2854,   364, 256},
                                                                                                  {-2852,   364, 248},
                                                                                                  {-2840,   372, 248},
