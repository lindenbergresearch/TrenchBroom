...
"ChangeBrushFaceAttributesTest.resetAttributesOfValve220Face") {
...
game->
setDefaultFaceAttributes(defaultFaceAttrs);

auto reset = Model::ChangeBrushFaceAttributesRequest{};
reset.
resetAll(defaultFaceAttrs);

document->
setFaceAttributes(reset);
...
TEST_CASE_METHOD(ValveMapDocumentTest,
"ChangeBrushFaceAttributesTest.undoRedo")
{
...
TEST_CASE_METHOD(ValveMapDocumentTest,
"ChangeBrushFaceAttributesTest.setAll")
{
auto *brushNode = createBrushNode();
document->addNodes({
{
...
document->
setFaceAttributes(setFirstFace);
...
setSecondFace.
setColor(Color{0.5f, 0.5f, 0.5f, 0.5f}
);
document->
setFaceAttributes(setSecondFace);
...
.
face(secondFaceIndex)
);
document->
setFaceAttributes(copySecondToThirdFace);
...
document->
setFaceAttributes(copyFirstToSecondFace);
...
copyFirstToThirdFaceNoContents.
setAllExceptContentFlags(brushNode
->
...
document->
setFaceAttributes(copyFirstToThirdFaceNoContents);
...
TEST_CASE_METHOD(ValveMapDocumentTest,
"ChangeBrushFaceAttributesTest.setTextureKeepsSurfaceFlagsUnset")
{
auto *brushNode = createBrushNode();
document->addNodes({
{
...
CHECK(document
->
setFaceAttributesExceptContentFlags(waterbrush
->
