...
TEST_CASE_METHOD(MapDocumentTest, "LayerNodeTest.defaultLayerSortIndexImmutable", "[LayerNodesTest]")
{
...
TEST_CASE_METHOD(MapDocumentTest, "LayerNodeTest.duplicateObjectGoesIntoSourceLayer", "[LayerNodesTest]")
{
    // delete default brush
    document->selectAllNodes();
    document->deleteObjects();
...
TEST_CASE_METHOD(MapDocumentTest, "LayerNodeTest.newObjectsInHiddenLayerAreVisible", "[LayerNodesTest]")
{
    // delete default brush
    document->selectAllNodes();
    document->deleteObjects();
...
TEST_CASE_METHOD(MapDocumentTest, "LayerNodeTest.duplicatedObjectInHiddenLayerIsVisible", "[LayerNodesTest]")
{
    // delete default brush
    document->selectAllNodes();
    document->deleteObjects();
...
TEST_CASE_METHOD(MapDocumentTest, "LayerNodeTest.newObjectsInLockedLayerAreUnlocked", "[LayerNodesTest]")
{
    // delete default brush
    document->selectAllNodes();
    document->deleteObjects();
