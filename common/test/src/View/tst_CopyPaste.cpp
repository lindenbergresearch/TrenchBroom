...
== 1u);
CHECK(
dynamic_cast<Model::BrushNode*>(defaultLayer
.
...
== 1u);
CHECK(
dynamic_cast<Model::BrushNode*>(groupNode
->
...
== 1u);
CHECK(
dynamic_cast<Model::BrushNode*>(entityNode
->
...
== 1u);
CHECK(
dynamic_cast<Model::PatchNode*>(defaultLayer
.
