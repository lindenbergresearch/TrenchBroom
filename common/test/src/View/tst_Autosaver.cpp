...
"MapDocumentTest.autosaverNoSaveUntilSaveInterval") {
...
CHECK_FALSE(env
.fileExists("autosave/test.1.map"));
CHECK_FALSE(env
.directoryExists("autosave"));
}

TEST_CASE_METHOD(MapDocumentTest,
"MapDocumentTest.autosaverNoSaveOfUnchangedMap")
{
using namespace std::literals::chrono_literals;
...
TEST_CASE_METHOD(MapDocumentTest,
"MapDocumentTest.autosaverSavesAfterSaveInterval")
{
using namespace std::literals::chrono_literals;
...
TEST_CASE_METHOD(MapDocumentTest,
"MapDocumentTest.autosaverSavesAgainAfterSaveInterval")
{
using namespace std::literals::chrono_literals;
...
triggerAutosave(logger);
CHECK_FALSE(env
.fileExists("autosave/test.2.map"));
...
TEST_CASE_METHOD(MapDocumentTest,
"MapDocumentTest.autosaverSavesWhenCrashFilesPresent")
{
