...
MapDocumentTest&)>;
CreateNode createNode = GENERATE_COPY(CreateNode{[](const auto &test) { return test.createBrushNode(); }}, CreateNode{[](const auto &test) { return test.createPatchNode(); }});
...
children(), Catch::UnorderedEquals(std::vector<Model::Node *>{groupNode, linkedGroupNode, linkedGroupNode2})
...
children(), Catch::UnorderedEquals(std::vector<Model::Node *>{groupNode, linkedGroupNode, linkedBrushNode2})
...
children(), Catch::UnorderedEquals(std::vector<Model::Node *>{groupNode, linkedBrushNode, linkedBrushNode2})
...
children(), Catch::UnorderedEquals(std::vector<Model::Node *>{brushNode, linkedBrushNode, linkedBrushNode2})
...
nodes(), Catch::UnorderedEquals(std::vector<Model::Node *>{groupNode, linkedGroupNode})
...
->
newDocument(
    Model::MapFormat::Valve, MapDocument::DefaultWorldBounds, document
->
...
auto *brushNode = createBrushNode();
Model::transformNode(
    *brushNode, vm::translation_matrix(vm::vec3{0, 0, -32}), document
->
