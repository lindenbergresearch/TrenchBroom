...
const auto [lhs, rhs, mask, expected] = GENERATE(values<T>({
                                                               // clang-format off
                                                               {ActionContext::View3D, ActionContext::View2D, ActionContext::AnyView, false}, {ActionContext::View3D, ActionContext::View3D, ActionContext::AnyView, true}, {ActionContext::View3D, ActionContext::View3D, ActionContext::AnyTool, false}, {ActionContext::AnyView, ActionContext::View2D, ActionContext::AnyView, true}, {ActionContext::AnyView, ActionContext::View3D, ActionContext::AnyView, true}, {ActionContext::AnyView, ActionContext::View3D, ActionContext::AnyTool, false}, {ActionContext::RotateTool, ActionContext::Any, ActionContext::AnyTool, true}, {ActionContext::View3D, ActionContext::AnyTool, ActionContext::AnyTool, false},
                                                               // clang-format on
                                                           }));
...
const auto [lhs, rhs, expected] = GENERATE(values<T>({
                                                         ...
                                                         {ActionContext::Any, ActionContext::View2D | ActionContext::NoSelection | ActionContext::NoTool, true}, {ActionContext::Any, ActionContext::View3D | ActionContext::NoSelection | ActionContext::NoTool, true}, {ActionContext::Any, ActionContext::View3D | ActionContext::NodeSelection | ActionContext::NoTool, true}, {ActionContext::Any, ActionContext::View3D | ActionContext::NoSelection | ActionContext::RotateTool, true}, {ActionContext::Any, ActionContext::View3D | ActionContext::NodeSelection | ActionContext::RotateTool, true},
                                                         ...
                                                         {ActionContext::Any, ActionContext::View3D | ActionContext::NoSelection | ActionContext::NoTool, true}, {ActionContext::Any, ActionContext::View3D | ActionContext::NodeSelection | ActionContext::NoTool, true}, {ActionContext::Any, ActionContext::View3D | ActionContext::NoSelection | ActionContext::RotateTool, true}, {ActionContext::Any, ActionContext::View3D | ActionContext::NodeSelection | ActionContext::RotateTool, true},
