...
textures1.
push_back(makeDummyTexture("skin1")
);
surface1.
setSkins(std::move(textures1)
);

auto builder1 = makeDummyBuilder();
surface1.
addIndexedMesh(frame, builder1
.
...
textures2.
push_back(makeDummyTexture("skin2a")
);
textures2.
push_back(makeDummyTexture("skin2b")
);
surface2.
setSkins(std::move(textures2)
);

auto builder2 = makeDummyBuilder();
surface2.
addIndexedMesh(frame, builder2
.
