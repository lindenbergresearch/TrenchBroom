...
TEST_CASE("ExpressionTest.testValueLiterals")
{
    ...
    // clang-format off
    const auto [expression, expectedValue] = GENERATE(values<T>({{"true",         Value{true}},
                                                                 {"false",        Value{false}},
                                                                 {"'asdf'",       Value{"asdf"}},
                                                                 {"2",            Value{2}},
                                                                 {"-2",           Value{-2}},
...
TEST_CASE("ExpressionTest.testVariableExpression")
{
    ...
    // clang-format off
    const auto [expression, variables, expectedValue] = GENERATE(values<T>({{"x", {{"x", Value{true}}}, Value{true}},
                                                                            {
                                                                             "x", {{
                                                                                    "y", Value{
                                                                                    true
...
TEST_CASE("ExpressionTest.testArrayExpression")
{
    ...
    // clang-format off
    const auto [expression, variables, expectedValue] = GENERATE(values<T>({{"[]",        {}, {}},
                                                                            {
                                                                             "[1, 2, 3]", {}, {
                                                                                                  Value{
                                                                                                      1
...
TEST_CASE("ExpressionTest.testOperators")
{
    ...
    const auto [expression, expectedValueOrError] = GENERATE(values<T>({
            ...
            {
                "[1, 2] + [2, 3]",                        Value{
                ArrayType{Value{1}, Value{2}, Value{2}, Value{3}}}},
            {   "[] + {}",                                EvaluationError{}},
            ...
            {   "{} + []",                                EvaluationError{}},
            {
                "{k1: 1, k2: 2, k3: 3} + {k3: 4, k4: 5}", Value{
                MapType{{"k1", Value{1}},
                        {"k2", Value{2}},
                        {"k3", Value{4}},
                        {"k4", Value{5}},
            ...
            {
                "true / false",                           Value{
                std::numeric_limits<NumberType>::infinity()
            }},
            {
                "true / 3",                               Value{
                1.0 / 3.0
            ...
            {
                "{k1:1} < {k1:1, k2:2}",                  Value{
                true
            }},
            {
                "{k1:1} < {k1:2, k2:2}",                  Value{
                true
            }},
...
TEST_CASE("ExpressionTest.testOperatorPrecedence")
{
    ...
    // clang-format off
    const auto [expression, expectedValue] = GENERATE(values<T>({{"1 + 2 - 3",                Value{1.0 + 2.0 - 3.0}},
...
TEST_CASE("ExpressionTest.testOptimize")
{
    ...
    // clang-format off
    const auto [expression, expectedExpression] = GENERATE(values<T>({{
                                                                          "3 + 7",           Expression{
                LiteralExpression{Value{10}}, 0, 0
            }},
                                                                      {
                                                                          "[1, 2, 3]",       Expression{
                                                                          LiteralExpression{
                                                                              Value{
                                                                                  ArrayType{Value{1}, Value{2}, Value{3}}}}, 0, 0
                                                                      }},
                                                                      {
                                                                          "[1 + 2, 2, a]",   Expression{
                                                                          ArrayExpression{{
                                                                                              Expression{
                                                                                                  LiteralExpression{Value{3}}, 0, 0
                                                                                              }, Expression{
                                                                                  LiteralExpression{Value{2}}, 0, 0
                                                                              }, Expression{VariableExpression{"a"}, 0, 0}}}, 0, 0
                                                                      }},
                                                                      {
                                                                          "{a:1, b:2, c:3}", Expression{
                                                                          LiteralExpression{
                                                                              Value{
                                                                                  MapType{{"a", Value{1}},
                                                                                          {"b", Value{2}},
