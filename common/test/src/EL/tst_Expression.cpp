...
TEST_CASE("ExpressionTest.testValueLiterals")
{
    ...
    const auto
        [expression, expectedValue] = GENERATE(values<T>({
                                                             ...
                                                             {"{k1:2, k2:3}", Value{MapType{{"k1", Value{2}},
                                                                                            {"k2", Value{3}}}}},
                                                         }));
    // clang-format on
...
TEST_CASE("ExpressionTest.testArrayExpression")
{
    ...
    const auto
        [expression, variables, expectedValue] = GENERATE(values<T>({
                                                                        ...
                                                                        {"[1, 2, 3]", {},                     {Value{
                                                                            1}, Value{2}, Value{3}}},
                                                                        {"[1, 2, x]", {{"x", Value{"test"}}}, {Value{
                                                                            1}, Value{2}, Value{"test"}}},
                                                                    }));
    // clang-format on
...
TEST_CASE("ExpressionTest.testMapExpression")
{
    ...
    const auto
        [expression, variables, expectedValue] = GENERATE(values<T>({
                                                                        ...
                                                                        {"{k: true}",                    {}, {{"k",  Value{
                                                                            true}}}},
                                                                        {"{k1: true, k2: 3, k3: 3 + 7}", {}, {{"k1", Value{
                                                                            true}},   {"k2", Value{3}}, {"k3", Value{
                                                                            10}}}},
                                                                        {"{k1: 'asdf', k2: x}",          {{"x", Value{
                                                                            55}}},                           {{"k1", Value{
                                                                            "asdf"}}, {"k2", Value{55}}}},
                                                                    }));
    // clang-format on
...
TEST_CASE("ExpressionTest.testOperators")
{
    ...
    const auto
        [expression, expectedValueOrError] = GENERATE(values<T>({
                                                                    ...
                                                                    {"[] + null",                              EvaluationError{}},
                                                                    {"[1, 2] + [2, 3]",                        Value{
                                                                        ArrayType{Value{1}, Value{2}, Value{2},
                                                                                  Value{3}}}},
                                                                    {"[] + {}",                                EvaluationError{}},
...
TEST_CASE("ExpressionTest.testOptimize")
{
    ...
    const auto
        [expression, expectedExpression] = GENERATE(values<T>({
                                                                  ...
                                                                  {"[1, 2, 3]",       Expression{LiteralExpression{
                                                                      Value{ArrayType{Value{1}, Value{2}, Value{3}}}},
                                                                                                 0, 0}},
                                                                  ...
                                                                  {"{a:1, b:2, c:3}", Expression{LiteralExpression{
                                                                      Value{MapType{{"a", Value{1}},
                                                                                    {"b", Value{2}},
                                                                                    {"c", Value{3}}}}}, 0, 0}},
                                                              }));
    // clang-format on
