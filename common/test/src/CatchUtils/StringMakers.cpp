...
namespace {
void printNodes(const std::vector<Node *> &nodes, const std::string &indent, std::ostream &str);
...
void printWorldNode(const WorldNode &worldNode, const std::string &indent, std::ostream &str) {
...
void printLayerNode(const LayerNode &layerNode, const std::string &indent, std::ostream &str) {
    const auto childIndent = indent + "  ";
...
void printGroupNode(const GroupNode &groupNode, const std::string &indent, std::ostream &str) {
    const auto childIndent = indent + "  ";
...
void printEntityNode(const EntityNode &entityNode, const std::string &indent, std::ostream &str) {
    const auto childIndent = indent + "  ";
...
void printBrushNode(const BrushNode &brushNode, const std::string &indent, std::ostream &str) {
    const auto childIndent = indent + "  ";
...
void printPatchNode(const PatchNode &patchNode, const std::string &indent, std::ostream &str) {
    const auto childIndent = indent + "  ";
...
void printNode(const Node &node, const std::string &indent, std::ostream &str) {
    node.accept(kdl::overload([&](const WorldNode *worldNode) { printWorldNode(*worldNode, indent, str); }, [&](const LayerNode *layerNode) { printLayerNode(*layerNode, indent, str); }, [&](const GroupNode *groupNode) { printGroupNode(*groupNode, indent, str); }, [&](const EntityNode *entityNode) { printEntityNode(*entityNode, indent, str); }, [&](const BrushNode *brushNode) { printBrushNode(*brushNode, indent, str); }, [&](const PatchNode *patchNode) { printPatchNode(*patchNode, indent, str); }));
}
